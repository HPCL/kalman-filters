...
Best performance cost: 
  [1.644e-06, 7.83e-07, 4.6e-07, 4.06e-07, 4.05e-07, 4.01e-07, 4.05e-07, 4.05e-07, 4.05e-07, 4.03e-07, 3.98e-07, 4.05e-07, 4.03e-07, 4.02e-07, 4.03e-07, 4.04e-07, 4.02e-07, 4.01e-07, 4.34e-07, 4.1e-07, 4.04e-07, 4.03e-07, 4e-07, 4.06e-07, 4.04e-07, 4.05e-07, 4.03e-07, 4.03e-07, 4.03e-07, 4.01e-07, 4.05e-07, 4.03e-07, 4.05e-07, 4.03e-07, 4.25e-07, 4.03e-07, 4.03e-07, 4.03e-07, 4.05e-07, 4.03e-07, 4.05e-07, 4.04e-07, 4.04e-07, 4.04e-07, 4.05e-07, 4.05e-07, 4.05e-07, 4.05e-07, 4.02e-07, 4.02e-07] 
...
--**/
...
) @*/
  {
    ...
    }
    {
      ...
      for (i2=n-((n-(i2t))%5); i2<=n-1; i2=i2+1) 
        for (j2=0; j2<=n-1; j2++ ) {
          if (i2==j2) {
            P[n*i2+j2]=1;
            L[n*i2+j2]=1;
  ...
  for (i=0; i<=n-1; i++ ) {
    ...
    }
    {
      ...
      for (j=i+1; j<=n-4; j=j+4) {
        ...
        coeff=(U[(j+2)*n+i]/U[i*n+i]);
        coeff=(U[(j+3)*n+i]/U[i*n+i]);
        L[j*n+i]=coeff;
        L[(j+1)*n+i]=coeff;
        L[(j+2)*n+i]=coeff;
        L[(j+3)*n+i]=coeff;
...
#pragma vector always
        for (k=i; k<=cbv_1; k++ ) {
          ...
          U[(j+2)*n+k]=U[(j+2)*n+k]-coeff*U[i*n+k];
          U[(j+3)*n+k]=U[(j+3)*n+k]-coeff*U[i*n+k];
        }
      }
