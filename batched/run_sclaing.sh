...
do
  ...
  # do
    # export CALI_REPORT_FILENAME=$DIR/cali_L2_tca_many_$elms-$bats.json
    # make test_tuned MATS=16777216 ELMS=$elms REPS=10 BATCH=$bats
    make test_cblas MATS=16777216 ELMS=$elms REPS=10 BATCH=$bats
    echo
    ./test_linear.out
    echo
  # done
