...
double *t8 = t13;
double *t7 = t13;
for (i=0; i<A_nrows; i+=__s201) {
// 2_1
int __m201 = i + __s201 > A_nrows ? A_nrows - i : __s201;
...
for (i=0; i<A_nrows; i+=__s202) {
// 4_1
int __m202 = i + __s202 > A_nrows ? A_nrows - i : __s202;
double *t16 = xhn + i*xh_ncols;
double *t14 = t8 + i*xh_ncols;
double *t15 = Y + i*xh_ncols;
for (j=0; j<__m202; j+=1) {
// 4_2
