...
double *t8 = t13;
double *t7 = t13;
for (i=0; i<A_nrows; i+=__s203) {
// 2_1
int __m203 = i + __s203 > A_nrows ? A_nrows - i : __s203;
double *t12 = t13 + i*xh_ncols;
double *t11 = A + i*A_ncols;
for (j=0; j<__m203; j+=1) {
// 2_2
...
for (i=0; i<A_nrows; i+=__s204) {
// 4_1
int __m204 = i + __s204 > A_nrows ? A_nrows - i : __s204;
