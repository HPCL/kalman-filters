...
double *t8 = t13;
double *t7 = t13;
for (i=0; i<A_nrows; i+=__s209) {
// 2_1
int __m209 = i + __s209 > A_nrows ? A_nrows - i : __s209;
double *t12 = t13 + i*xh_ncols;
double *t11 = A + i*A_ncols;
for (j=0; j<__m209; j+=1) {
// 2_2
...
for (i=0; i<A_nrows; i+=__s210) {
// 4_1
int __m210 = i + __s210 > A_nrows ? A_nrows - i : __s210;
double *t16 = xhn + i*xh_ncols;
double *t14 = t8 + i*xh_ncols;
double *t15 = Y + i*xh_ncols;
for (j=0; j<__m210; j+=1) {
// 4_2
