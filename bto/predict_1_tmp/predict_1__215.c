...
double *t24 = malloc(sizeof(double)*__s238*xh_ncols);
...
int nparts__s239 = 8;
int __s239;
if (nparts__s239 > 1 && A_nrows > nparts__s239) {
__s239 = A_nrows/nparts__s239;
// this will fail if A_nrows%nparts__s239+__s239 > nparts__s239
// which primarily effects small sizes
if (A_nrows%nparts__s239)
++__s239;
}
else {
__s239 = A_nrows;
...
predict1_0_msg_t *predict1_0 = malloc(sizeof(predict1_0_msg_t)*nparts__s239);
pthread_t *threads_0 = malloc(sizeof(pthread_t)*nparts__s239);
disp = 0;
for (i=0,ii=0; i<A_nrows; i+=__s239,ii+=1) {
// 2_1
int __m239 = i + __s239 > A_nrows ? A_nrows - i : __s239;
...
predict1_0[disp].__s238 = __s238;
predict1_0[disp].__m239 = __m239;
