...
for (j=0; j<__m59; j+=__s58) {
// 2_2
int __m58 = j + __s58 > __m59 ? __m59 - j : __s58;
...
int nparts__s59 = 10;
int __s59;
if (nparts__s59 > 1 && A_nrows > nparts__s59) {
__s59 = A_nrows/nparts__s59;
// this will fail if A_nrows%nparts__s59+__s59 > nparts__s59
// which primarily effects small sizes
if (A_nrows%nparts__s59)
++__s59;
}
else {
__s59 = A_nrows;
...
predict1_0_msg_t *predict1_0 = malloc(sizeof(predict1_0_msg_t)*nparts__s59);
pthread_t *threads_0 = malloc(sizeof(pthread_t)*nparts__s59);
disp = 0;
for (i=0,ii=0; i<A_nrows; i+=__s59,ii+=1) {
// 2_1
int __m59 = i + __s59 > A_nrows ? A_nrows - i : __s59;
...
predict1_0[disp].__s58 = __s58;
predict1_0[disp].__m59 = __m59;

pthread_create(&threads_0[disp], NULL, predict1_body_0, (void *)(predict1_0+disp));
++disp;
}
for (disp = 0; disp < nparts__s59; ++disp) {
