...
double *t8 = t13;
double *t7 = t13;
for (i=0; i<xh_ncols; i+=__s265) {
// 2_1
int __m265 = i + __s265 > xh_ncols ? xh_ncols - i : __s265;
double *t12 = t13 + i;
double *t11 = xh + i;
...
for (__zr__ = 0; __zr__ < __m265; ++__zr__) t19[__zr__] = 0.0;
for (k=0; k<A_ncols; k+=1) {
// 2_3
double *t26 = t11 + k*xh_ncols;
for (l=0; l<__m265; l+=1) {
// 2_4
t19[l] += (t18[k]*t26[l]);
}
}
...
for (i=0; i<A_nrows; i+=__s266) {
// 4_1
int __m266 = i + __s266 > A_nrows ? A_nrows - i : __s266;
double *t16 = xhn + i*xh_ncols;
double *t14 = t8 + i*xh_ncols;
double *t15 = Y + i*xh_ncols;
for (j=0; j<__m266; j+=1) {
// 4_2
