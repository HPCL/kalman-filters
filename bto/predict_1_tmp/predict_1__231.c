...
double *t8 = t13;
double *t7 = t13;
for (i=0; i<A_nrows; i+=__s267) {
// 2_1
int __m267 = i + __s267 > A_nrows ? A_nrows - i : __s267;
double *t12 = t13 + i*xh_ncols;
double *t11 = A + i*A_ncols;
for (j=0; j<__m267; j+=1) {
// 2_2
...
for (i=0; i<A_nrows; i+=__s268) {
// 4_1
int __m268 = i + __s268 > A_nrows ? A_nrows - i : __s268;
double *t16 = xhn + i*xh_ncols;
double *t14 = t8 + i*xh_ncols;
double *t15 = Y + i*xh_ncols;
for (j=0; j<__m268; j+=1) {
// 4_2
