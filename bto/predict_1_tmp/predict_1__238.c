...
double *t8 = t13;
double *t7 = t13;
for (i=0; i<xh_ncols; i+=__s274) {
// 2_1
int __m274 = i + __s274 > xh_ncols ? xh_ncols - i : __s274;
double *t12 = t13 + i;
double *t11 = xh + i;
...
for (__zr__ = 0; __zr__ < __m274; ++__zr__) t19[__zr__] = 0.0;
...
for (i=0; i<A_nrows; i+=__s275) {
// 4_1
int __m275 = i + __s275 > A_nrows ? A_nrows - i : __s275;
