...
double *t8 = t14;
for (i=0; i<A_ncols; i+=__s391) {
// 2_1
int __m391 = i + __s391 > A_ncols ? A_ncols - i : __s391;
double *t11 = A + i;
...
for (i=0; i<A_nrows; i+=__s392) {
// 4_1
int __m392 = i + __s392 > A_nrows ? A_nrows - i : __s392;
double *t17 = xhn + i*xh_ncols;
double *t15 = t8 + i*xh_ncols;
double *t16 = Y + i*xh_ncols;
for (j=0; j<__m392; j+=1) {
// 4_2
