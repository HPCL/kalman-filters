...
double *t8 = t13;
double *t7 = t13;
for (i=0; i<A_nrows; i+=__s450) {
// 2_1
int __m450 = i + __s450 > A_nrows ? A_nrows - i : __s450;
double *t12 = t13 + i*xh_ncols;
double *t11 = A + i*A_ncols;
for (j=0; j<__m450; j+=1) {
// 2_2
...
for (i=0; i<A_nrows; i+=__s451) {
// 4_1
int __m451 = i + __s451 > A_nrows ? A_nrows - i : __s451;
double *t16 = xhn + i*xh_ncols;
double *t14 = t8 + i*xh_ncols;
double *t15 = Y + i*xh_ncols;
for (j=0; j<__m451; j+=1) {
// 4_2
