...
double *t8 = t13;
double *t7 = t13;
for (i=0; i<xh_ncols; i+=__s549) {
// 2_1
int __m549 = i + __s549 > xh_ncols ? xh_ncols - i : __s549;
double *t12 = t13 + i;
double *t11 = xh + i;
...
for (__zr__ = 0; __zr__ < __m549; ++__zr__) t19[__zr__] = 0.0;
for (k=0; k<A_ncols; k+=1) {
// 2_3
double *t26 = t11 + k*xh_ncols;
for (l=0; l<__m549; l+=1) {
// 2_4
t19[l] += (t18[k]*t26[l]);
}
}
...
for (i=0; i<xh_ncols; i+=__s550) {
// 4_1
int __m550 = i + __s550 > xh_ncols ? xh_ncols - i : __s550;
double *t16 = xhn + i;
double *t14 = t8 + i;
double *t15 = Y + i;
for (j=0; j<A_nrows; j+=1) {
