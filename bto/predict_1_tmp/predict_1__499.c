...
double *t8 = t13;
double *t7 = t13;
for (i=0; i<A_nrows; i+=__s577) {
// 2_1
int __m577 = i + __s577 > A_nrows ? A_nrows - i : __s577;
double *t12 = t13 + i*xh_ncols;
double *t11 = A + i*A_ncols;
for (j=0; j<__m577; j+=1) {
// 2_2
...
for (i=0; i<A_nrows; i+=__s578) {
// 4_1
int __m578 = i + __s578 > A_nrows ? A_nrows - i : __s578;
double *t16 = xhn + i*xh_ncols;
double *t14 = t8 + i*xh_ncols;
double *t15 = Y + i*xh_ncols;
for (j=0; j<__m578; j+=1) {
// 4_2
