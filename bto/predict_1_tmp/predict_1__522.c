...
double *t8 = t13;
double *t7 = t13;
for (i=0; i<A_nrows; i+=__s610) {
// 2_1
int __m610 = i + __s610 > A_nrows ? A_nrows - i : __s610;
double *t12 = t13 + i*xh_ncols;
double *t11 = A + i*A_ncols;
for (j=0; j<__m610; j+=1) {
// 2_2
...
for (i=0; i<xh_ncols; i+=__s611) {
// 4_1
int __m611 = i + __s611 > xh_ncols ? xh_ncols - i : __s611;
double *t16 = xhn + i;
double *t14 = t8 + i;
double *t15 = Y + i;
