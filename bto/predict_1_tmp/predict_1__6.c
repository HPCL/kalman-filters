...
for (j=0; j<__m19; j+=__s18) {
// 2_2
int __m18 = j + __s18 > __m19 ? __m19 - j : __s18;
...
int nparts__s19 = 12;
int __s19;
if (nparts__s19 > 1 && A_nrows > nparts__s19) {
__s19 = A_nrows/nparts__s19;
// this will fail if A_nrows%nparts__s19+__s19 > nparts__s19
// which primarily effects small sizes
if (A_nrows%nparts__s19)
++__s19;
}
else {
__s19 = A_nrows;
...
predict1_0_msg_t *predict1_0 = malloc(sizeof(predict1_0_msg_t)*nparts__s19);
pthread_t *threads_0 = malloc(sizeof(pthread_t)*nparts__s19);
disp = 0;
for (i=0,ii=0; i<A_nrows; i+=__s19,ii+=1) {
// 2_1
int __m19 = i + __s19 > A_nrows ? A_nrows - i : __s19;
...
predict1_0[disp].__s18 = __s18;
predict1_0[disp].__m19 = __m19;

pthread_create(&threads_0[disp], NULL, predict1_body_0, (void *)(predict1_0+disp));
++disp;
}
for (disp = 0; disp < nparts__s19; ++disp) {
