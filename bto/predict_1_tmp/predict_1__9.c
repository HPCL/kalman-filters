...
int nparts__s31 = 10;
int __s31;
if (nparts__s31 > 1 && A_nrows > nparts__s31) {
__s31 = A_nrows/nparts__s31;
// this will fail if A_nrows%nparts__s31+__s31 > nparts__s31
// which primarily effects small sizes
if (A_nrows%nparts__s31)
++__s31;
}
else {
__s31 = A_nrows;
...
predict1_0_msg_t *predict1_0 = malloc(sizeof(predict1_0_msg_t)*nparts__s31);
pthread_t *threads_0 = malloc(sizeof(pthread_t)*nparts__s31);
disp = 0;
for (i=0,ii=0; i<A_nrows; i+=__s31,ii+=1) {
// 2_1
int __m31 = i + __s31 > A_nrows ? A_nrows - i : __s31;
...
predict1_0[disp].__s30 = __s30;
predict1_0[disp].__m31 = __m31;
