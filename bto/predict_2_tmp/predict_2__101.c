...
double *t10 = t19;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s299) {
// 2_1
int __m299 = i + __s299 > P_ncols ? P_ncols - i : __s299;
double *t13 = t8 + i;
...
for (i=0; i<P_ncols; i+=__s300) {
// 6_1
int __m300 = i + __s300 > P_ncols ? P_ncols - i : __s300;
double *t22 = P + i*P_ncols;
double *t20 = t10 + i*P_ncols;
double *t21 = Q + i*P_ncols;
for (j=0; j<__m300; j+=1) {
// 6_2
