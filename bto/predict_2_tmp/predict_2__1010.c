...
double *t9 = t17;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s2569) {
// 2_1
int __m2569 = i + __s2569 > P_ncols ? P_ncols - i : __s2569;
double *t16 = t17 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m2569; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s2570) {
// 4_1
int __m2570 = i + __s2570 > P_ncols ? P_ncols - i : __s2570;
double *t19 = t20 + i*P_ncols;
double *t18 = t10 + i*P_ncols;
for (j=0; j<__m2570; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s2571) {
// 6_1
int __m2571 = i + __s2571 > P_ncols ? P_ncols - i : __s2571;
double *t23 = P + i*P_ncols;
double *t21 = t12 + i*P_ncols;
double *t22 = Q + i*P_ncols;
for (j=0; j<__m2571; j+=1) {
// 6_2
