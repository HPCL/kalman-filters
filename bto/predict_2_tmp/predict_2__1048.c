...
double *t8 = A;
double *t12 = A;
for (i=0; i<P_ncols; i+=__s2713) {
// 2_1
int __m2713 = i + __s2713 > P_ncols ? P_ncols - i : __s2713;
double *t17 = t18 + i*P_ncols;
double *t16 = t8 + i*P_ncols;
for (j=0; j<__m2713; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s2714) {
// 4_1
int __m2714 = i + __s2714 > P_ncols ? P_ncols - i : __s2714;
double *t20 = t21 + i;
...
for (i=0; i<P_ncols; i+=__s2715) {
// 6_1
int __m2715 = i + __s2715 > P_ncols ? P_ncols - i : __s2715;
double *t24 = P + i*P_ncols;
double *t22 = t13 + i*P_ncols;
double *t23 = Q + i*P_ncols;
for (j=0; j<__m2715; j+=1) {
// 6_2
