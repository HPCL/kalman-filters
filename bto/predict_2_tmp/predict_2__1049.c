...
double *t9 = t17;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s2716) {
// 2_1
int __m2716 = i + __s2716 > P_ncols ? P_ncols - i : __s2716;
double *t16 = t17 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m2716; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s2717) {
// 4_1
int __m2717 = i + __s2717 > P_ncols ? P_ncols - i : __s2717;
double *t19 = t20 + i*P_ncols;
double *t18 = t10 + i*P_ncols;
for (j=0; j<__m2717; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s2718) {
// 6_1
int __m2718 = i + __s2718 > P_ncols ? P_ncols - i : __s2718;
double *t23 = P + i;
double *t21 = t12 + i;
double *t22 = Q + i;
