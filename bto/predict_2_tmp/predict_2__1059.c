...
double *t9 = t17;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s2753) {
// 2_1
int __m2753 = i + __s2753 > P_ncols ? P_ncols - i : __s2753;
double *t16 = t17 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m2753; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s2754) {
// 4_1
int __m2754 = i + __s2754 > P_ncols ? P_ncols - i : __s2754;
double *t19 = t20 + i*P_ncols;
double *t18 = t10 + i*P_ncols;
for (j=0; j<__m2754; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s2755) {
// 6_1
int __m2755 = i + __s2755 > P_ncols ? P_ncols - i : __s2755;
double *t23 = P + i*P_ncols;
double *t21 = t12 + i*P_ncols;
double *t22 = Q + i*P_ncols;
for (j=0; j<__m2755; j+=1) {
// 6_2
