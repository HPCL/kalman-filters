...
double *t8 = A;
double *t12 = A;
for (i=0; i<P_ncols; i+=__s2767) {
// 2_1
int __m2767 = i + __s2767 > P_ncols ? P_ncols - i : __s2767;
double *t17 = t18 + i*P_ncols;
double *t16 = t8 + i*P_ncols;
for (j=0; j<__m2767; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s2768) {
// 4_1
int __m2768 = i + __s2768 > P_ncols ? P_ncols - i : __s2768;
double *t20 = t21 + i;
...
for (i=0; i<P_ncols; i+=__s2769) {
// 6_1
int __m2769 = i + __s2769 > P_ncols ? P_ncols - i : __s2769;
double *t24 = P + i;
double *t22 = t13 + i;
double *t23 = Q + i;
for (j=0; j<P_ncols; j+=1) {
