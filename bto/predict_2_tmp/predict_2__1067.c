...
double *t9 = t14;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s2770) {
// 2_1
int __m2770 = i + __s2770 > P_ncols ? P_ncols - i : __s2770;
double *t13 = t14 + i*P_ncols;
double *t12 = t8 + i*P_ncols;
for (j=0; j<__m2770; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s2771) {
// 4_1
int __m2771 = i + __s2771 > P_ncols ? P_ncols - i : __s2771;
double *t16 = t17 + i*P_ncols;
double *t15 = t10 + i*P_ncols;
for (j=0; j<__m2771; j+=1) {
// 4_2
