...
double *t8 = A;
double *t12 = A;
for (i=0; i<P_ncols; i+=__s2785) {
// 2_1
int __m2785 = i + __s2785 > P_ncols ? P_ncols - i : __s2785;
double *t17 = t18 + i*P_ncols;
double *t16 = t8 + i*P_ncols;
for (j=0; j<__m2785; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s2786) {
// 4_1
int __m2786 = i + __s2786 > P_ncols ? P_ncols - i : __s2786;
double *t20 = t21 + i;
...
for (i=0; i<P_ncols; i+=__s2787) {
// 6_1
int __m2787 = i + __s2787 > P_ncols ? P_ncols - i : __s2787;
double *t24 = P + i;
double *t22 = t13 + i;
double *t23 = Q + i;
for (j=0; j<P_ncols; j+=1) {
