...
double *t9 = t17;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s2788) {
// 2_1
int __m2788 = i + __s2788 > P_ncols ? P_ncols - i : __s2788;
double *t16 = t17 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m2788; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s2789) {
// 4_1
int __m2789 = i + __s2789 > P_ncols ? P_ncols - i : __s2789;
double *t19 = t20 + i*P_ncols;
double *t18 = t10 + i*P_ncols;
for (j=0; j<__m2789; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s2790) {
// 6_1
int __m2790 = i + __s2790 > P_ncols ? P_ncols - i : __s2790;
double *t23 = P + i*P_ncols;
double *t21 = t12 + i*P_ncols;
double *t22 = Q + i*P_ncols;
for (j=0; j<__m2790; j+=1) {
// 6_2
