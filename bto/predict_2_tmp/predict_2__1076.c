...
double *t18 = malloc(sizeof(double)*P_ncols*__s2798);
...
for (i=0; i<P_ncols; i+=__s2798) {
// 4_1
int __m2798 = i + __s2798 > P_ncols ? P_ncols - i : __s2798;
double *t22 = P + i;
double *t24 = t10 + i*P_ncols;
double *t21 = Q + i;
for (j=0; j<P_ncols; j+=1) {
// 4_2
double *t30 = t18 + j*__m2798;
double *t29 = t16 + j*P_ncols;
for (k=0; k<__m2798; k+=1) {
// 4_3
