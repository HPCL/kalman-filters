...
double *t8 = A;
double *t12 = A;
for (i=0; i<P_ncols; i+=__s2800) {
// 2_1
int __m2800 = i + __s2800 > P_ncols ? P_ncols - i : __s2800;
double *t14 = t15 + i*P_ncols;
double *t13 = t8 + i*P_ncols;
for (j=0; j<__m2800; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s2801) {
// 4_1
int __m2801 = i + __s2801 > P_ncols ? P_ncols - i : __s2801;
double *t17 = t18 + i;
