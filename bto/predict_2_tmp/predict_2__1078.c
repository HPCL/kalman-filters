...
double *t9 = t14;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s2802) {
// 2_1
int __m2802 = i + __s2802 > P_ncols ? P_ncols - i : __s2802;
double *t13 = t14 + i*P_ncols;
double *t12 = t8 + i*P_ncols;
for (j=0; j<__m2802; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s2803) {
// 4_1
int __m2803 = i + __s2803 > P_ncols ? P_ncols - i : __s2803;
double *t16 = t17 + i*P_ncols;
double *t15 = t10 + i*P_ncols;
for (j=0; j<__m2803; j+=1) {
// 4_2
