...
double *t9 = t17;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s2804) {
// 2_1
int __m2804 = i + __s2804 > P_ncols ? P_ncols - i : __s2804;
double *t16 = t17 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m2804; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s2805) {
// 4_1
int __m2805 = i + __s2805 > P_ncols ? P_ncols - i : __s2805;
double *t19 = t20 + i*P_ncols;
double *t18 = t10 + i*P_ncols;
for (j=0; j<__m2805; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s2806) {
// 6_1
int __m2806 = i + __s2806 > P_ncols ? P_ncols - i : __s2806;
double *t23 = P + i*P_ncols;
double *t21 = t12 + i*P_ncols;
double *t22 = Q + i*P_ncols;
for (j=0; j<__m2806; j+=1) {
// 6_2
