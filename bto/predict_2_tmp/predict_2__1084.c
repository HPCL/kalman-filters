...
double *t9 = t15;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s2813) {
// 2_1
int __m2813 = i + __s2813 > P_ncols ? P_ncols - i : __s2813;
double *t14 = t15 + i*P_ncols;
double *t13 = t8 + i*P_ncols;
for (j=0; j<__m2813; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s2814) {
// 6_1
int __m2814 = i + __s2814 > P_ncols ? P_ncols - i : __s2814;
double *t21 = P + i;
double *t19 = t10 + i;
double *t20 = Q + i;
for (j=0; j<P_ncols; j+=1) {
