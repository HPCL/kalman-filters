...
for (i=0; i<P_ncols; i+=__s2819) {
// 4_1
int __m2819 = i + __s2819 > P_ncols ? P_ncols - i : __s2819;
double *t17 = t18 + i*P_ncols;
double *t16 = t8 + i*P_ncols;
for (j=0; j<__m2819; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s2820) {
// 6_1
int __m2820 = i + __s2820 > P_ncols ? P_ncols - i : __s2820;
double *t21 = P + i*P_ncols;
double *t19 = t10 + i*P_ncols;
double *t20 = Q + i*P_ncols;
for (j=0; j<__m2820; j+=1) {
// 6_2
