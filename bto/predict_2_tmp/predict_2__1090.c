...
double *t9 = t17;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s2828) {
// 2_1
int __m2828 = i + __s2828 > P_ncols ? P_ncols - i : __s2828;
double *t16 = t17 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m2828; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s2829) {
// 4_1
int __m2829 = i + __s2829 > P_ncols ? P_ncols - i : __s2829;
double *t19 = t20 + i*P_ncols;
double *t18 = t10 + i*P_ncols;
for (j=0; j<__m2829; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s2830) {
// 6_1
int __m2830 = i + __s2830 > P_ncols ? P_ncols - i : __s2830;
double *t23 = P + i;
double *t21 = t12 + i;
double *t22 = Q + i;
