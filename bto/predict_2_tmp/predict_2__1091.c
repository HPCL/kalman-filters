...
double *t9 = t15;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s2831) {
// 2_1
int __m2831 = i + __s2831 > P_ncols ? P_ncols - i : __s2831;
double *t14 = t15 + i*P_ncols;
double *t13 = t8 + i*P_ncols;
for (j=0; j<__m2831; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s2832) {
// 6_1
int __m2832 = i + __s2832 > P_ncols ? P_ncols - i : __s2832;
double *t21 = P + i*P_ncols;
double *t19 = t10 + i*P_ncols;
double *t20 = Q + i*P_ncols;
for (j=0; j<__m2832; j+=1) {
// 6_2
