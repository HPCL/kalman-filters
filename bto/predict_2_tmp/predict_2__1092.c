...
double *t8 = A;
double *t12 = A;
for (i=0; i<P_ncols; i+=__s2833) {
// 2_1
int __m2833 = i + __s2833 > P_ncols ? P_ncols - i : __s2833;
double *t17 = t18 + i*P_ncols;
double *t16 = t8 + i*P_ncols;
for (j=0; j<__m2833; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s2834) {
// 4_1
int __m2834 = i + __s2834 > P_ncols ? P_ncols - i : __s2834;
double *t20 = t21 + i;
...
for (i=0; i<P_ncols; i+=__s2835) {
// 6_1
int __m2835 = i + __s2835 > P_ncols ? P_ncols - i : __s2835;
double *t24 = P + i;
double *t22 = t13 + i;
double *t23 = Q + i;
for (j=0; j<P_ncols; j+=1) {
