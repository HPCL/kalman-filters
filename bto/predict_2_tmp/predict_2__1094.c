...
double *t19 = malloc(sizeof(double)*__s2841*P_ncols);
double *t17 = malloc(sizeof(double)*P_ncols*P_ncols);
double *t10 = t17;
double *t9 = t17;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s2840) {
// 2_1
int __m2840 = i + __s2840 > P_ncols ? P_ncols - i : __s2840;
double *t16 = t17 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m2840; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s2841) {
// 4_1
int __m2841 = i + __s2841 > P_ncols ? P_ncols - i : __s2841;
double *t23 = P + i*P_ncols;
double *t18 = t10 + i*P_ncols;
double *t22 = Q + i*P_ncols;
for (j=0; j<__m2841; j+=1) {
// 4_2
