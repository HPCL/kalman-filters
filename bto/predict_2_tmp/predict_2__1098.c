...
double *t9 = t17;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s2852) {
// 2_1
int __m2852 = i + __s2852 > P_ncols ? P_ncols - i : __s2852;
double *t16 = t17 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m2852; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s2853) {
// 4_1
int __m2853 = i + __s2853 > P_ncols ? P_ncols - i : __s2853;
double *t19 = t20 + i*P_ncols;
double *t18 = t10 + i*P_ncols;
for (j=0; j<__m2853; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s2854) {
// 6_1
int __m2854 = i + __s2854 > P_ncols ? P_ncols - i : __s2854;
double *t23 = P + i;
double *t21 = t12 + i;
double *t22 = Q + i;
