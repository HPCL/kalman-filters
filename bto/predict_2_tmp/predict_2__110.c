...
double *t9 = t15;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s320) {
// 2_1
int __m320 = i + __s320 > P_ncols ? P_ncols - i : __s320;
double *t14 = t15 + i*P_ncols;
double *t13 = t8 + i*P_ncols;
for (j=0; j<__m320; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s321) {
// 6_1
int __m321 = i + __s321 > P_ncols ? P_ncols - i : __s321;
double *t21 = P + i*P_ncols;
double *t19 = t10 + i*P_ncols;
double *t20 = Q + i*P_ncols;
for (j=0; j<__m321; j+=1) {
// 6_2
