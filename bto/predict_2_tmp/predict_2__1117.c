...
double *t9 = t17;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s2885) {
// 2_1
int __m2885 = i + __s2885 > P_ncols ? P_ncols - i : __s2885;
double *t16 = t17 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m2885; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s2886) {
// 4_1
int __m2886 = i + __s2886 > P_ncols ? P_ncols - i : __s2886;
double *t19 = t20 + i*P_ncols;
double *t18 = t10 + i*P_ncols;
for (j=0; j<__m2886; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s2887) {
// 6_1
int __m2887 = i + __s2887 > P_ncols ? P_ncols - i : __s2887;
double *t23 = P + i;
double *t21 = t12 + i;
double *t22 = Q + i;
