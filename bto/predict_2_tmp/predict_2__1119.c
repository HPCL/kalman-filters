...
double *t9 = t17;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s2888) {
// 2_1
int __m2888 = i + __s2888 > P_ncols ? P_ncols - i : __s2888;
double *t16 = t17 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m2888; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s2889) {
// 4_1
int __m2889 = i + __s2889 > P_ncols ? P_ncols - i : __s2889;
double *t19 = t20 + i*P_ncols;
double *t18 = t10 + i*P_ncols;
for (j=0; j<__m2889; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s2890) {
// 6_1
int __m2890 = i + __s2890 > P_ncols ? P_ncols - i : __s2890;
double *t23 = P + i*P_ncols;
double *t21 = t12 + i*P_ncols;
double *t22 = Q + i*P_ncols;
for (j=0; j<__m2890; j+=1) {
// 6_2
