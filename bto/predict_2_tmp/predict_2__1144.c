...
double *t9 = t17;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s2951) {
// 2_1
int __m2951 = i + __s2951 > P_ncols ? P_ncols - i : __s2951;
double *t16 = t17 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m2951; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s2952) {
// 4_1
int __m2952 = i + __s2952 > P_ncols ? P_ncols - i : __s2952;
double *t19 = t20 + i*P_ncols;
double *t18 = t10 + i*P_ncols;
for (j=0; j<__m2952; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s2953) {
// 6_1
int __m2953 = i + __s2953 > P_ncols ? P_ncols - i : __s2953;
double *t23 = P + i*P_ncols;
double *t21 = t12 + i*P_ncols;
double *t22 = Q + i*P_ncols;
for (j=0; j<__m2953; j+=1) {
// 6_2
