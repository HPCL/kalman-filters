...
double *t9 = t17;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s2968) {
// 2_1
int __m2968 = i + __s2968 > P_ncols ? P_ncols - i : __s2968;
double *t16 = t17 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m2968; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s2969) {
// 4_1
int __m2969 = i + __s2969 > P_ncols ? P_ncols - i : __s2969;
double *t19 = t20 + i*P_ncols;
double *t18 = t10 + i*P_ncols;
for (j=0; j<__m2969; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s2970) {
// 6_1
int __m2970 = i + __s2970 > P_ncols ? P_ncols - i : __s2970;
double *t23 = P + i*P_ncols;
double *t21 = t12 + i*P_ncols;
double *t22 = Q + i*P_ncols;
for (j=0; j<__m2970; j+=1) {
// 6_2
