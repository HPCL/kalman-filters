...
for (i=0; i<P_ncols; i+=__s2971) {
// 4_1
int __m2971 = i + __s2971 > P_ncols ? P_ncols - i : __s2971;
double *t17 = t18 + i*P_ncols;
double *t16 = t8 + i*P_ncols;
for (j=0; j<__m2971; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s2972) {
// 6_1
int __m2972 = i + __s2972 > P_ncols ? P_ncols - i : __s2972;
double *t21 = P + i*P_ncols;
double *t19 = t10 + i*P_ncols;
double *t20 = Q + i*P_ncols;
for (j=0; j<__m2972; j+=1) {
// 6_2
