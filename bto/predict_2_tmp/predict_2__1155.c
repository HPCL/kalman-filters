...
double *t10 = t18;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s2973) {
// 2_1
int __m2973 = i + __s2973 > P_ncols ? P_ncols - i : __s2973;
double *t15 = t8 + i;
...
for (i=0; i<P_ncols; i+=__s2974) {
// 4_1
int __m2974 = i + __s2974 > P_ncols ? P_ncols - i : __s2974;
double *t20 = t21 + i*P_ncols;
double *t19 = t10 + i*P_ncols;
for (j=0; j<__m2974; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s2975) {
// 6_1
int __m2975 = i + __s2975 > P_ncols ? P_ncols - i : __s2975;
double *t24 = P + i*P_ncols;
double *t22 = t12 + i*P_ncols;
double *t23 = Q + i*P_ncols;
for (j=0; j<__m2975; j+=1) {
// 6_2
