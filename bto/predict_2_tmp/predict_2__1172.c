...
double *t9 = t17;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s3009) {
// 2_1
int __m3009 = i + __s3009 > P_ncols ? P_ncols - i : __s3009;
double *t16 = t17 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m3009; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s3010) {
// 4_1
int __m3010 = i + __s3010 > P_ncols ? P_ncols - i : __s3010;
double *t19 = t20 + i*P_ncols;
double *t18 = t10 + i*P_ncols;
for (j=0; j<__m3010; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s3011) {
// 6_1
int __m3011 = i + __s3011 > P_ncols ? P_ncols - i : __s3011;
double *t23 = P + i*P_ncols;
double *t21 = t12 + i*P_ncols;
double *t22 = Q + i*P_ncols;
for (j=0; j<__m3011; j+=1) {
// 6_2
