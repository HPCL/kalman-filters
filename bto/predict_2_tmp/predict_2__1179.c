...
for (i=0; i<P_ncols; i+=__s3025) {
// 4_1
int __m3025 = i + __s3025 > P_ncols ? P_ncols - i : __s3025;
double *t17 = t18 + i*P_ncols;
double *t16 = t8 + i*P_ncols;
for (j=0; j<__m3025; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s3026) {
// 6_1
int __m3026 = i + __s3026 > P_ncols ? P_ncols - i : __s3026;
double *t21 = P + i*P_ncols;
double *t19 = t10 + i*P_ncols;
double *t20 = Q + i*P_ncols;
for (j=0; j<__m3026; j+=1) {
// 6_2
