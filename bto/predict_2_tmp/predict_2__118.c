...
double *t9 = t15;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s330) {
// 2_1
int __m330 = i + __s330 > P_ncols ? P_ncols - i : __s330;
double *t14 = t15 + i*P_ncols;
double *t13 = t8 + i*P_ncols;
for (j=0; j<__m330; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s331) {
// 6_1
int __m331 = i + __s331 > P_ncols ? P_ncols - i : __s331;
double *t21 = P + i*P_ncols;
double *t19 = t10 + i*P_ncols;
double *t20 = Q + i*P_ncols;
for (j=0; j<__m331; j+=1) {
// 6_2
