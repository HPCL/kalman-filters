...
double *t19 = malloc(sizeof(double)*__s3044*P_ncols);
double *t17 = malloc(sizeof(double)*P_ncols*P_ncols);
double *t10 = t17;
double *t9 = t17;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s3043) {
// 2_1
int __m3043 = i + __s3043 > P_ncols ? P_ncols - i : __s3043;
double *t16 = t17 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m3043; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s3044) {
// 4_1
int __m3044 = i + __s3044 > P_ncols ? P_ncols - i : __s3044;
double *t23 = P + i*P_ncols;
double *t18 = t10 + i*P_ncols;
double *t22 = Q + i*P_ncols;
for (j=0; j<__m3044; j+=1) {
// 4_2
