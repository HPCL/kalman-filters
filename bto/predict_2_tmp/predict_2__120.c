...
double *t9 = t15;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s337) {
// 2_1
int __m337 = i + __s337 > P_ncols ? P_ncols - i : __s337;
double *t14 = t15 + i*P_ncols;
double *t13 = t8 + i*P_ncols;
for (j=0; j<__m337; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s338) {
// 6_1
int __m338 = i + __s338 > P_ncols ? P_ncols - i : __s338;
double *t21 = P + i*P_ncols;
double *t19 = t10 + i*P_ncols;
double *t20 = Q + i*P_ncols;
for (j=0; j<__m338; j+=1) {
// 6_2
