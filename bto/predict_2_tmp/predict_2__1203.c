...
double *t9 = t17;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s3074) {
// 2_1
int __m3074 = i + __s3074 > P_ncols ? P_ncols - i : __s3074;
double *t16 = t17 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m3074; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s3075) {
// 4_1
int __m3075 = i + __s3075 > P_ncols ? P_ncols - i : __s3075;
double *t19 = t20 + i*P_ncols;
double *t18 = t10 + i*P_ncols;
for (j=0; j<__m3075; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s3076) {
// 6_1
int __m3076 = i + __s3076 > P_ncols ? P_ncols - i : __s3076;
double *t23 = P + i*P_ncols;
double *t21 = t12 + i*P_ncols;
double *t22 = Q + i*P_ncols;
for (j=0; j<__m3076; j+=1) {
// 6_2
