...
double *t19 = malloc(sizeof(double)*__s3098*P_ncols);
double *t16 = malloc(sizeof(double)*__s3098*P_ncols);
double *t8 = A;
for (i=0; i<P_ncols; i+=__s3098) {
// 2_1
int __m3098 = i + __s3098 > P_ncols ? P_ncols - i : __s3098;
double *t23 = P + i*P_ncols;
double *t15 = t8 + i*P_ncols;
double *t22 = Q + i*P_ncols;
for (j=0; j<__m3098; j+=1) {
// 2_2
