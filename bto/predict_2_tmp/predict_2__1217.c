...
double *t9 = t17;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s3101) {
// 2_1
int __m3101 = i + __s3101 > P_ncols ? P_ncols - i : __s3101;
double *t16 = t17 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m3101; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s3102) {
// 4_1
int __m3102 = i + __s3102 > P_ncols ? P_ncols - i : __s3102;
double *t19 = t20 + i*P_ncols;
double *t18 = t10 + i*P_ncols;
for (j=0; j<__m3102; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s3103) {
// 6_1
int __m3103 = i + __s3103 > P_ncols ? P_ncols - i : __s3103;
double *t23 = P + i*P_ncols;
double *t21 = t12 + i*P_ncols;
double *t22 = Q + i*P_ncols;
for (j=0; j<__m3103; j+=1) {
// 6_2
