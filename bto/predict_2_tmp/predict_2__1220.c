...
for (i=0; i<P_ncols; i+=__s3113) {
// 4_1
int __m3113 = i + __s3113 > P_ncols ? P_ncols - i : __s3113;
double *t17 = t18 + i*P_ncols;
double *t16 = t8 + i*P_ncols;
for (j=0; j<__m3113; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s3114) {
// 6_1
int __m3114 = i + __s3114 > P_ncols ? P_ncols - i : __s3114;
double *t21 = P + i*P_ncols;
double *t19 = t10 + i*P_ncols;
double *t20 = Q + i*P_ncols;
for (j=0; j<__m3114; j+=1) {
// 6_2
