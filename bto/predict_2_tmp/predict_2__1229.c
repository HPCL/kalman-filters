...
double *t9 = t17;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s3134) {
// 2_1
int __m3134 = i + __s3134 > P_ncols ? P_ncols - i : __s3134;
double *t16 = t17 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m3134; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s3135) {
// 4_1
int __m3135 = i + __s3135 > P_ncols ? P_ncols - i : __s3135;
double *t19 = t20 + i*P_ncols;
double *t18 = t10 + i*P_ncols;
for (j=0; j<__m3135; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s3136) {
// 6_1
int __m3136 = i + __s3136 > P_ncols ? P_ncols - i : __s3136;
double *t23 = P + i*P_ncols;
double *t21 = t12 + i*P_ncols;
double *t22 = Q + i*P_ncols;
for (j=0; j<__m3136; j+=1) {
// 6_2
