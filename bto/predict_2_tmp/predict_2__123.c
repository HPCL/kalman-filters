...
double *t9 = t17;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s344) {
// 2_1
int __m344 = i + __s344 > P_ncols ? P_ncols - i : __s344;
double *t16 = t17 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m344; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s345) {
// 4_1
int __m345 = i + __s345 > P_ncols ? P_ncols - i : __s345;
double *t19 = t20 + i*P_ncols;
double *t18 = t10 + i*P_ncols;
for (j=0; j<__m345; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s346) {
// 6_1
int __m346 = i + __s346 > P_ncols ? P_ncols - i : __s346;
double *t23 = P + i*P_ncols;
double *t21 = t12 + i*P_ncols;
double *t22 = Q + i*P_ncols;
for (j=0; j<__m346; j+=1) {
// 6_2
