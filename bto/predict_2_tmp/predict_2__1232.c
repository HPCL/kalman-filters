...
double *t9 = t17;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s3141) {
// 2_1
int __m3141 = i + __s3141 > P_ncols ? P_ncols - i : __s3141;
double *t16 = t17 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m3141; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s3142) {
// 4_1
int __m3142 = i + __s3142 > P_ncols ? P_ncols - i : __s3142;
double *t19 = t20 + i*P_ncols;
double *t18 = t10 + i*P_ncols;
for (j=0; j<__m3142; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s3143) {
// 6_1
int __m3143 = i + __s3143 > P_ncols ? P_ncols - i : __s3143;
double *t23 = P + i*P_ncols;
double *t21 = t12 + i*P_ncols;
double *t22 = Q + i*P_ncols;
for (j=0; j<__m3143; j+=1) {
// 6_2
