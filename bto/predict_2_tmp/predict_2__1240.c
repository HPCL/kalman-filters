...
double *t9 = t15;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s3163) {
// 2_1
int __m3163 = i + __s3163 > P_ncols ? P_ncols - i : __s3163;
double *t14 = t15 + i*P_ncols;
double *t13 = t8 + i*P_ncols;
for (j=0; j<__m3163; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s3164) {
// 6_1
int __m3164 = i + __s3164 > P_ncols ? P_ncols - i : __s3164;
double *t21 = P + i*P_ncols;
double *t19 = t10 + i*P_ncols;
double *t20 = Q + i*P_ncols;
for (j=0; j<__m3164; j+=1) {
// 6_2
