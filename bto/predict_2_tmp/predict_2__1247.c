...
double *t9 = t17;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s3184) {
// 2_1
int __m3184 = i + __s3184 > P_ncols ? P_ncols - i : __s3184;
double *t16 = t17 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m3184; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s3185) {
// 4_1
int __m3185 = i + __s3185 > P_ncols ? P_ncols - i : __s3185;
double *t19 = t20 + i*P_ncols;
double *t18 = t10 + i*P_ncols;
for (j=0; j<__m3185; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s3186) {
// 6_1
int __m3186 = i + __s3186 > P_ncols ? P_ncols - i : __s3186;
double *t23 = P + i;
double *t21 = t12 + i;
double *t22 = Q + i;
