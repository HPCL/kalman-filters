...
double *t9 = t15;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s352) {
// 2_1
int __m352 = i + __s352 > P_ncols ? P_ncols - i : __s352;
double *t14 = t15 + i*P_ncols;
double *t13 = t8 + i*P_ncols;
for (j=0; j<__m352; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s353) {
// 6_1
int __m353 = i + __s353 > P_ncols ? P_ncols - i : __s353;
double *t21 = P + i*P_ncols;
double *t19 = t10 + i*P_ncols;
double *t20 = Q + i*P_ncols;
for (j=0; j<__m353; j+=1) {
// 6_2
