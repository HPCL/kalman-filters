...
double *t10 = t18;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s3210) {
// 2_1
int __m3210 = i + __s3210 > P_ncols ? P_ncols - i : __s3210;
double *t15 = t8 + i;
...
for (i=0; i<P_ncols; i+=__s3211) {
// 4_1
int __m3211 = i + __s3211 > P_ncols ? P_ncols - i : __s3211;
double *t20 = t21 + i*P_ncols;
double *t19 = t10 + i*P_ncols;
for (j=0; j<__m3211; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s3212) {
// 6_1
int __m3212 = i + __s3212 > P_ncols ? P_ncols - i : __s3212;
double *t24 = P + i;
double *t22 = t12 + i;
double *t23 = Q + i;
for (j=0; j<P_ncols; j+=1) {
