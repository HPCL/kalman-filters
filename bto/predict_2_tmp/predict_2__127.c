...
for (i=0; i<P_ncols; i+=__s355) {
// 4_1
int __m355 = i + __s355 > P_ncols ? P_ncols - i : __s355;
double *t17 = t18 + i*P_ncols;
double *t16 = t8 + i*P_ncols;
for (j=0; j<__m355; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s356) {
// 6_1
int __m356 = i + __s356 > P_ncols ? P_ncols - i : __s356;
double *t21 = P + i*P_ncols;
double *t19 = t10 + i*P_ncols;
double *t20 = Q + i*P_ncols;
for (j=0; j<__m356; j+=1) {
// 6_2
