...
for (i=0; i<P_ncols; i+=__s357) {
// 4_1
int __m357 = i + __s357 > P_ncols ? P_ncols - i : __s357;
double *t17 = t18 + i*P_ncols;
double *t16 = t8 + i*P_ncols;
for (j=0; j<__m357; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s358) {
// 6_1
int __m358 = i + __s358 > P_ncols ? P_ncols - i : __s358;
double *t21 = P + i*P_ncols;
double *t19 = t10 + i*P_ncols;
double *t20 = Q + i*P_ncols;
for (j=0; j<__m358; j+=1) {
// 6_2
