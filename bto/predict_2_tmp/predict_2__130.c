...
for (j=0; j<P_ncols; j+=__s361) {
// 6_2
int __m361 = j + __s361 > P_ncols ? P_ncols - j : __s361;
...
int nparts__s362 = 12;
int __s362;
if (nparts__s362 > 1 && P_ncols > nparts__s362) {
__s362 = P_ncols/nparts__s362;
// this will fail if P_ncols%nparts__s362+__s362 > nparts__s362
// which primarily effects small sizes
if (P_ncols%nparts__s362)
++__s362;
}
else {
__s362 = P_ncols;
...
predict_0_msg_t *predict_0 = malloc(sizeof(predict_0_msg_t)*nparts__s362);
pthread_t *threads_0 = malloc(sizeof(pthread_t)*nparts__s362);
disp = 0;
for (i=0,ii=0; i<P_ncols; i+=__s362,ii+=1) {
// 6_1
int __m362 = i + __s362 > P_ncols ? P_ncols - i : __s362;
double *t22 = P + i;
double *t20 = t11 + i;
double *t21 = Q + i;
predict_0[disp].__m362 = __m362;
predict_0[disp].P_ncols = P_ncols;
predict_0[disp].t21 = t21;
predict_0[disp].t20 = t20;
predict_0[disp].t22 = t22;
predict_0[disp].__s361 = __s361;
