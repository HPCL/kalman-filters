...
double *t9 = t17;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s3320) {
// 2_1
int __m3320 = i + __s3320 > P_ncols ? P_ncols - i : __s3320;
double *t16 = t17 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m3320; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s3321) {
// 4_1
int __m3321 = i + __s3321 > P_ncols ? P_ncols - i : __s3321;
double *t19 = t20 + i*P_ncols;
double *t18 = t10 + i*P_ncols;
for (j=0; j<__m3321; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s3322) {
// 6_1
int __m3322 = i + __s3322 > P_ncols ? P_ncols - i : __s3322;
double *t23 = P + i*P_ncols;
double *t21 = t12 + i*P_ncols;
double *t22 = Q + i*P_ncols;
for (j=0; j<__m3322; j+=1) {
// 6_2
