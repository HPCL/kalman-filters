...
double *t9 = t14;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s3345) {
// 2_1
int __m3345 = i + __s3345 > P_ncols ? P_ncols - i : __s3345;
double *t13 = t14 + i*P_ncols;
double *t12 = t8 + i*P_ncols;
for (j=0; j<__m3345; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s3346) {
// 4_1
int __m3346 = i + __s3346 > P_ncols ? P_ncols - i : __s3346;
double *t16 = t17 + i*P_ncols;
double *t15 = t10 + i*P_ncols;
for (j=0; j<__m3346; j+=1) {
// 4_2
