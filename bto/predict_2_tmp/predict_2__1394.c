...
double *t9 = t15;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s3347) {
// 2_1
int __m3347 = i + __s3347 > P_ncols ? P_ncols - i : __s3347;
double *t14 = t15 + i*P_ncols;
double *t13 = t8 + i*P_ncols;
for (j=0; j<__m3347; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s3348) {
// 6_1
int __m3348 = i + __s3348 > P_ncols ? P_ncols - i : __s3348;
double *t21 = P + i*P_ncols;
double *t19 = t10 + i*P_ncols;
double *t20 = Q + i*P_ncols;
for (j=0; j<__m3348; j+=1) {
// 6_2
