...
double *t19 = malloc(sizeof(double)*__s3363*P_ncols);
double *t16 = malloc(sizeof(double)*__s3363*P_ncols);
double *t8 = A;
for (i=0; i<P_ncols; i+=__s3363) {
// 2_1
int __m3363 = i + __s3363 > P_ncols ? P_ncols - i : __s3363;
double *t23 = P + i*P_ncols;
double *t15 = t8 + i*P_ncols;
double *t22 = Q + i*P_ncols;
for (j=0; j<__m3363; j+=1) {
// 2_2
