...
double *t10 = t18;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s3417) {
// 2_1
int __m3417 = i + __s3417 > P_ncols ? P_ncols - i : __s3417;
double *t15 = t8 + i;
...
for (i=0; i<P_ncols; i+=__s3418) {
// 4_1
int __m3418 = i + __s3418 > P_ncols ? P_ncols - i : __s3418;
double *t20 = t21 + i*P_ncols;
double *t19 = t10 + i*P_ncols;
for (j=0; j<__m3418; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s3419) {
// 6_1
int __m3419 = i + __s3419 > P_ncols ? P_ncols - i : __s3419;
double *t24 = P + i*P_ncols;
double *t22 = t12 + i*P_ncols;
double *t23 = Q + i*P_ncols;
for (j=0; j<__m3419; j+=1) {
// 6_2
