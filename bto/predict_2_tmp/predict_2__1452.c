...
double *t9 = t15;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s3436) {
// 2_1
int __m3436 = i + __s3436 > P_ncols ? P_ncols - i : __s3436;
double *t14 = t15 + i*P_ncols;
double *t13 = t8 + i*P_ncols;
for (j=0; j<__m3436; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s3437) {
// 6_1
int __m3437 = i + __s3437 > P_ncols ? P_ncols - i : __s3437;
double *t21 = P + i;
double *t19 = t10 + i;
double *t20 = Q + i;
for (j=0; j<P_ncols; j+=1) {
