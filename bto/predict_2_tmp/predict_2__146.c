...
for (i=0; i<P_ncols; i+=__s399) {
// 4_1
int __m399 = i + __s399 > P_ncols ? P_ncols - i : __s399;
double *t17 = t18 + i*P_ncols;
double *t16 = t8 + i*P_ncols;
for (j=0; j<__m399; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s400) {
// 6_1
int __m400 = i + __s400 > P_ncols ? P_ncols - i : __s400;
double *t21 = P + i*P_ncols;
double *t19 = t10 + i*P_ncols;
double *t20 = Q + i*P_ncols;
for (j=0; j<__m400; j+=1) {
// 6_2
