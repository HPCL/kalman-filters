...
double *t10 = t19;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s3452) {
// 2_1
int __m3452 = i + __s3452 > P_ncols ? P_ncols - i : __s3452;
double *t13 = t8 + i;
...
for (i=0; i<P_ncols; i+=__s3453) {
// 6_1
int __m3453 = i + __s3453 > P_ncols ? P_ncols - i : __s3453;
double *t22 = P + i;
double *t20 = t10 + i;
double *t21 = Q + i;
for (j=0; j<P_ncols; j+=1) {
