...
double *t9 = t14;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s3454) {
// 2_1
int __m3454 = i + __s3454 > P_ncols ? P_ncols - i : __s3454;
double *t13 = t14 + i*P_ncols;
double *t12 = t8 + i*P_ncols;
for (j=0; j<__m3454; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s3455) {
// 4_1
int __m3455 = i + __s3455 > P_ncols ? P_ncols - i : __s3455;
double *t16 = t17 + i*P_ncols;
double *t15 = t10 + i*P_ncols;
for (j=0; j<__m3455; j+=1) {
// 4_2
