...
double *t9 = t14;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s3488) {
// 2_1
int __m3488 = i + __s3488 > P_ncols ? P_ncols - i : __s3488;
double *t13 = t14 + i*P_ncols;
double *t12 = t8 + i*P_ncols;
for (j=0; j<__m3488; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s3489) {
// 4_1
int __m3489 = i + __s3489 > P_ncols ? P_ncols - i : __s3489;
double *t16 = t17 + i*P_ncols;
double *t15 = t10 + i*P_ncols;
for (j=0; j<__m3489; j+=1) {
// 4_2
