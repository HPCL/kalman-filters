...
double *t9 = t17;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s411) {
// 2_1
int __m411 = i + __s411 > P_ncols ? P_ncols - i : __s411;
double *t16 = t17 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m411; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s412) {
// 4_1
int __m412 = i + __s412 > P_ncols ? P_ncols - i : __s412;
double *t19 = t20 + i*P_ncols;
double *t18 = t10 + i*P_ncols;
for (j=0; j<__m412; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s413) {
// 6_1
int __m413 = i + __s413 > P_ncols ? P_ncols - i : __s413;
double *t23 = P + i*P_ncols;
double *t21 = t12 + i*P_ncols;
double *t22 = Q + i*P_ncols;
for (j=0; j<__m413; j+=1) {
// 6_2
