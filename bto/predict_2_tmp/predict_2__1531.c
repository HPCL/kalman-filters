...
for (i=0; i<P_ncols; i+=__s3569) {
// 4_1
int __m3569 = i + __s3569 > P_ncols ? P_ncols - i : __s3569;
double *t17 = t18 + i*P_ncols;
double *t16 = t8 + i*P_ncols;
for (j=0; j<__m3569; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s3570) {
// 6_1
int __m3570 = i + __s3570 > P_ncols ? P_ncols - i : __s3570;
double *t21 = P + i;
double *t19 = t10 + i;
double *t20 = Q + i;
for (j=0; j<P_ncols; j+=1) {
