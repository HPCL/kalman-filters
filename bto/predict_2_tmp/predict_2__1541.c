...
for (i=0; i<P_ncols; i+=__s3589) {
// 4_1
int __m3589 = i + __s3589 > P_ncols ? P_ncols - i : __s3589;
double *t18 = t19 + i;
...
for (i=0; i<P_ncols; i+=__s3590) {
// 6_1
int __m3590 = i + __s3590 > P_ncols ? P_ncols - i : __s3590;
double *t22 = P + i;
double *t20 = t11 + i;
double *t21 = Q + i;
for (j=0; j<P_ncols; j+=1) {
