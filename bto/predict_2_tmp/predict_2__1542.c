...
double *t8 = A;
double *t12 = A;
for (i=0; i<P_ncols; i+=__s3591) {
// 2_1
int __m3591 = i + __s3591 > P_ncols ? P_ncols - i : __s3591;
double *t17 = t18 + i*P_ncols;
double *t16 = t8 + i*P_ncols;
for (j=0; j<__m3591; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s3592) {
// 4_1
int __m3592 = i + __s3592 > P_ncols ? P_ncols - i : __s3592;
double *t20 = t21 + i;
...
for (i=0; i<P_ncols; i+=__s3593) {
// 6_1
int __m3593 = i + __s3593 > P_ncols ? P_ncols - i : __s3593;
double *t24 = P + i;
double *t22 = t13 + i;
double *t23 = Q + i;
for (j=0; j<P_ncols; j+=1) {
