...
double *t16 = malloc(sizeof(double)*__s3598*P_ncols);
double *t20 = malloc(sizeof(double)*P_ncols*P_ncols);
double *t12 = t20;
double *t11 = t20;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s3598) {
// 2_1
int __m3598 = i + __s3598 > P_ncols ? P_ncols - i : __s3598;
double *t19 = t20 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m3598; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s3600) {
// 6_1
int __m3600 = i + __s3600 > P_ncols ? P_ncols - i : __s3600;
double *t23 = P + i;
double *t21 = t12 + i;
double *t22 = Q + i;
