...
for (j=0; j<__m430; j+=__s429) {
// 6_2
int __m429 = j + __s429 > __m430 ? __m430 - j : __s429;
double *t40 = t29 + j*P_ncols;
double *t38 = t27 + j*P_ncols;
double *t39 = t28 + j*P_ncols;
for (k=0; k<__m429; k+=1) {
// 6_3
...
int nparts__s430 = 10;
int __s430;
if (nparts__s430 > 1 && P_ncols > nparts__s430) {
__s430 = P_ncols/nparts__s430;
// this will fail if P_ncols%nparts__s430+__s430 > nparts__s430
// which primarily effects small sizes
if (P_ncols%nparts__s430)
++__s430;
}
else {
__s430 = P_ncols;
...
double *t8 = A;
double *t12 = A;
for (i=0; i<P_ncols; i+=__s427) {
// 2_1
int __m427 = i + __s427 > P_ncols ? P_ncols - i : __s427;
double *t19 = t8 + i;
...
for (i=0; i<P_ncols; i+=__s428) {
// 4_1
int __m428 = i + __s428 > P_ncols ? P_ncols - i : __s428;
double *t23 = t10 + i;
double *t31 = t12 + i;
for (j=0; j<P_ncols; j+=1) {
// 4_2
...
predict_0_msg_t *predict_0 = malloc(sizeof(predict_0_msg_t)*nparts__s430);
pthread_t *threads_0 = malloc(sizeof(pthread_t)*nparts__s430);
disp = 0;
for (i=0,ii=0; i<P_ncols; i+=__s430,ii+=1) {
// 6_1
int __m430 = i + __s430 > P_ncols ? P_ncols - i : __s430;
...
predict_0[disp].__s429 = __s429;
predict_0[disp].__m430 = __m430;
