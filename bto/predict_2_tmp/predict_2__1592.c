...
double *t8 = A;
double *t12 = A;
for (i=0; i<P_ncols; i+=__s3771) {
// 2_1
int __m3771 = i + __s3771 > P_ncols ? P_ncols - i : __s3771;
double *t14 = t15 + i*P_ncols;
double *t13 = t8 + i*P_ncols;
for (j=0; j<__m3771; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s3772) {
// 4_1
int __m3772 = i + __s3772 > P_ncols ? P_ncols - i : __s3772;
double *t17 = t18 + i;
