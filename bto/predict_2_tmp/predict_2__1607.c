...
double *t10 = t14;
double *t9 = t14;
for (i=0; i<P_ncols; i+=__s3807) {
// 2_1
int __m3807 = i + __s3807 > P_ncols ? P_ncols - i : __s3807;
double *t13 = t14 + i;
double *t12 = P + i;
...
for (__zr__ = 0; __zr__ < __m3807; ++__zr__) t23[__zr__] = 0.0;
for (k=0; k<P_ncols; k+=1) {
// 2_3
double *t33 = t12 + k*P_ncols;
for (l=0; l<__m3807; l+=1) {
// 2_4
t23[l] += (t22[k]*t33[l]);
}
}
...
for (i=0; i<P_ncols; i+=__s3808) {
// 4_1
int __m3808 = i + __s3808 > P_ncols ? P_ncols - i : __s3808;
double *t16 = t17 + i*P_ncols;
double *t15 = t10 + i*P_ncols;
for (j=0; j<__m3808; j+=1) {
// 4_2
