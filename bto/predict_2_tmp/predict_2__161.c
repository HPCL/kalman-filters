...
for (i=0; i<P_ncols; i+=__s436) {
// 4_1
int __m436 = i + __s436 > P_ncols ? P_ncols - i : __s436;
double *t17 = t18 + i*P_ncols;
double *t16 = t8 + i*P_ncols;
for (j=0; j<__m436; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s437) {
// 6_1
int __m437 = i + __s437 > P_ncols ? P_ncols - i : __s437;
double *t21 = P + i*P_ncols;
double *t19 = t10 + i*P_ncols;
double *t20 = Q + i*P_ncols;
for (j=0; j<__m437; j+=1) {
// 6_2
