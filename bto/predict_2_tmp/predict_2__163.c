...
double *t10 = t19;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s440) {
// 2_1
int __m440 = i + __s440 > P_ncols ? P_ncols - i : __s440;
double *t13 = t8 + i;
...
for (i=0; i<P_ncols; i+=__s441) {
// 6_1
int __m441 = i + __s441 > P_ncols ? P_ncols - i : __s441;
double *t22 = P + i*P_ncols;
double *t20 = t10 + i*P_ncols;
double *t21 = Q + i*P_ncols;
for (j=0; j<__m441; j+=1) {
// 6_2
