...
double *t8 = A;
double *t12 = A;
for (i=0; i<P_ncols; i+=__s3866) {
// 2_1
int __m3866 = i + __s3866 > P_ncols ? P_ncols - i : __s3866;
double *t14 = t15 + i*P_ncols;
double *t13 = t8 + i*P_ncols;
for (j=0; j<__m3866; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s3867) {
// 4_1
int __m3867 = i + __s3867 > P_ncols ? P_ncols - i : __s3867;
double *t17 = t18 + i;
