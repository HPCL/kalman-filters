...
double *t8 = A;
double *t12 = A;
for (i=0; i<P_ncols; i+=__s3893) {
// 2_1
int __m3893 = i + __s3893 > P_ncols ? P_ncols - i : __s3893;
double *t17 = t18 + i*P_ncols;
double *t16 = t8 + i*P_ncols;
for (j=0; j<__m3893; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s3894) {
// 4_1
int __m3894 = i + __s3894 > P_ncols ? P_ncols - i : __s3894;
double *t20 = t21 + i;
...
for (i=0; i<P_ncols; i+=__s3895) {
// 6_1
int __m3895 = i + __s3895 > P_ncols ? P_ncols - i : __s3895;
double *t24 = P + i;
double *t22 = t13 + i;
double *t23 = Q + i;
for (j=0; j<P_ncols; j+=1) {
