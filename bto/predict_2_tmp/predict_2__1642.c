...
double *t8 = A;
double *t12 = A;
for (i=0; i<P_ncols; i+=__s3897) {
// 2_1
int __m3897 = i + __s3897 > P_ncols ? P_ncols - i : __s3897;
double *t17 = t18 + i*P_ncols;
double *t16 = t8 + i*P_ncols;
for (j=0; j<__m3897; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s3898) {
// 4_1
int __m3898 = i + __s3898 > P_ncols ? P_ncols - i : __s3898;
double *t20 = t21 + i;
...
for (i=0; i<P_ncols; i+=__s3899) {
// 6_1
int __m3899 = i + __s3899 > P_ncols ? P_ncols - i : __s3899;
double *t24 = P + i*P_ncols;
double *t22 = t13 + i*P_ncols;
double *t23 = Q + i*P_ncols;
for (j=0; j<__m3899; j+=1) {
// 6_2
