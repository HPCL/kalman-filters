...
double *t8 = A;
double *t12 = A;
for (i=0; i<P_ncols; i+=__s3919) {
// 2_1
int __m3919 = i + __s3919 > P_ncols ? P_ncols - i : __s3919;
double *t14 = t15 + i*P_ncols;
double *t13 = t8 + i*P_ncols;
for (j=0; j<__m3919; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s3920) {
// 4_1
int __m3920 = i + __s3920 > P_ncols ? P_ncols - i : __s3920;
double *t17 = t18 + i;
