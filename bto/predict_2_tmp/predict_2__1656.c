...
double *t8 = A;
double *t12 = A;
for (i=0; i<P_ncols; i+=__s3923) {
// 2_1
int __m3923 = i + __s3923 > P_ncols ? P_ncols - i : __s3923;
double *t14 = t15 + i*P_ncols;
double *t13 = t8 + i*P_ncols;
for (j=0; j<__m3923; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s3924) {
// 4_1
int __m3924 = i + __s3924 > P_ncols ? P_ncols - i : __s3924;
double *t17 = t18 + i;
