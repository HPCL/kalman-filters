...
double *t9 = t17;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s3927) {
// 2_1
int __m3927 = i + __s3927 > P_ncols ? P_ncols - i : __s3927;
double *t16 = t17 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m3927; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s3928) {
// 4_1
int __m3928 = i + __s3928 > P_ncols ? P_ncols - i : __s3928;
double *t19 = t20 + i*P_ncols;
double *t18 = t10 + i*P_ncols;
for (j=0; j<__m3928; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s3929) {
// 6_1
int __m3929 = i + __s3929 > P_ncols ? P_ncols - i : __s3929;
double *t23 = P + i;
double *t21 = t12 + i;
double *t22 = Q + i;
