...
double *t9 = t15;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s4000) {
// 2_1
int __m4000 = i + __s4000 > P_ncols ? P_ncols - i : __s4000;
double *t14 = t15 + i*P_ncols;
double *t13 = t8 + i*P_ncols;
for (j=0; j<__m4000; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s4001) {
// 6_1
int __m4001 = i + __s4001 > P_ncols ? P_ncols - i : __s4001;
double *t21 = P + i*P_ncols;
double *t19 = t10 + i*P_ncols;
double *t20 = Q + i*P_ncols;
for (j=0; j<__m4001; j+=1) {
// 6_2
