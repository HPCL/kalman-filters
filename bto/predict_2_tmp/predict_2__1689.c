...
double *t8 = A;
double *t12 = A;
for (i=0; i<P_ncols; i+=__s4003) {
// 2_1
int __m4003 = i + __s4003 > P_ncols ? P_ncols - i : __s4003;
double *t17 = t18 + i*P_ncols;
double *t16 = t8 + i*P_ncols;
for (j=0; j<__m4003; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s4004) {
// 4_1
int __m4004 = i + __s4004 > P_ncols ? P_ncols - i : __s4004;
double *t20 = t21 + i;
...
for (i=0; i<P_ncols; i+=__s4005) {
// 6_1
int __m4005 = i + __s4005 > P_ncols ? P_ncols - i : __s4005;
double *t24 = P + i*P_ncols;
double *t22 = t13 + i*P_ncols;
double *t23 = Q + i*P_ncols;
for (j=0; j<__m4005; j+=1) {
// 6_2
