...
double *t12 = A;
double *t9 = t15;
for (i=0; i<P_ncols; i+=__s4053) {
// 2_1
int __m4053 = i + __s4053 > P_ncols ? P_ncols - i : __s4053;
double *t14 = t15 + i;
double *t13 = P + i;
...
for (__zr__ = 0; __zr__ < __m4053; ++__zr__) t25[__zr__] = 0.0;
for (k=0; k<P_ncols; k+=1) {
// 2_3
double *t35 = t13 + k*P_ncols;
for (l=0; l<__m4053; l+=1) {
// 2_4
t25[l] += (t24[k]*t35[l]);
}
}
...
for (i=0; i<P_ncols; i+=__s4054) {
// 4_1
int __m4054 = i + __s4054 > P_ncols ? P_ncols - i : __s4054;
double *t17 = t18 + i;
