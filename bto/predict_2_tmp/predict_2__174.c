...
double *t10 = t19;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s469) {
// 2_1
int __m469 = i + __s469 > P_ncols ? P_ncols - i : __s469;
double *t13 = t8 + i;
...
for (i=0; i<P_ncols; i+=__s470) {
// 6_1
int __m470 = i + __s470 > P_ncols ? P_ncols - i : __s470;
double *t22 = P + i*P_ncols;
double *t20 = t10 + i*P_ncols;
double *t21 = Q + i*P_ncols;
for (j=0; j<__m470; j+=1) {
// 6_2
