...
double *t9 = t17;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s471) {
// 2_1
int __m471 = i + __s471 > P_ncols ? P_ncols - i : __s471;
double *t16 = t17 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m471; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s472) {
// 4_1
int __m472 = i + __s472 > P_ncols ? P_ncols - i : __s472;
double *t19 = t20 + i*P_ncols;
double *t18 = t10 + i*P_ncols;
for (j=0; j<__m472; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s473) {
// 6_1
int __m473 = i + __s473 > P_ncols ? P_ncols - i : __s473;
double *t23 = P + i*P_ncols;
double *t21 = t12 + i*P_ncols;
double *t22 = Q + i*P_ncols;
for (j=0; j<__m473; j+=1) {
// 6_2
