...
double *t8 = A;
double *t12 = A;
for (i=0; i<P_ncols; i+=__s4093) {
// 2_1
int __m4093 = i + __s4093 > P_ncols ? P_ncols - i : __s4093;
double *t13 = t8 + i;
...
for (i=0; i<P_ncols; i+=__s4094) {
// 4_1
int __m4094 = i + __s4094 > P_ncols ? P_ncols - i : __s4094;
double *t18 = t19 + i;
