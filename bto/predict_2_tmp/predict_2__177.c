...
double *t9 = t15;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s477) {
// 2_1
int __m477 = i + __s477 > P_ncols ? P_ncols - i : __s477;
double *t14 = t15 + i*P_ncols;
double *t13 = t8 + i*P_ncols;
for (j=0; j<__m477; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s478) {
// 6_1
int __m478 = i + __s478 > P_ncols ? P_ncols - i : __s478;
double *t21 = P + i*P_ncols;
double *t19 = t10 + i*P_ncols;
double *t20 = Q + i*P_ncols;
for (j=0; j<__m478; j+=1) {
// 6_2
