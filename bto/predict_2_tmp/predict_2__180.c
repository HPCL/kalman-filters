...
for (i=0; i<P_ncols; i+=__s485) {
// 4_1
int __m485 = i + __s485 > P_ncols ? P_ncols - i : __s485;
double *t17 = t18 + i*P_ncols;
double *t16 = t8 + i*P_ncols;
for (j=0; j<__m485; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s486) {
// 6_1
int __m486 = i + __s486 > P_ncols ? P_ncols - i : __s486;
double *t21 = P + i*P_ncols;
double *t19 = t10 + i*P_ncols;
double *t20 = Q + i*P_ncols;
for (j=0; j<__m486; j+=1) {
// 6_2
