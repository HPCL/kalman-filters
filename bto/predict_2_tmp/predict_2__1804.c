...
double *t8 = A;
double *t12 = A;
for (i=0; i<P_ncols; i+=__s4229) {
// 2_1
int __m4229 = i + __s4229 > P_ncols ? P_ncols - i : __s4229;
double *t17 = t18 + i*P_ncols;
double *t16 = t8 + i*P_ncols;
for (j=0; j<__m4229; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s4230) {
// 4_1
int __m4230 = i + __s4230 > P_ncols ? P_ncols - i : __s4230;
double *t20 = t21 + i;
...
for (i=0; i<P_ncols; i+=__s4231) {
// 6_1
int __m4231 = i + __s4231 > P_ncols ? P_ncols - i : __s4231;
double *t24 = P + i;
double *t22 = t13 + i;
double *t23 = Q + i;
for (j=0; j<P_ncols; j+=1) {
