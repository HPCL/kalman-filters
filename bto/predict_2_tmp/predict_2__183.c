...
double *t9 = t17;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s493) {
// 2_1
int __m493 = i + __s493 > P_ncols ? P_ncols - i : __s493;
double *t16 = t17 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m493; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s494) {
// 4_1
int __m494 = i + __s494 > P_ncols ? P_ncols - i : __s494;
double *t19 = t20 + i*P_ncols;
double *t18 = t10 + i*P_ncols;
for (j=0; j<__m494; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s495) {
// 6_1
int __m495 = i + __s495 > P_ncols ? P_ncols - i : __s495;
double *t23 = P + i*P_ncols;
double *t21 = t12 + i*P_ncols;
double *t22 = Q + i*P_ncols;
for (j=0; j<__m495; j+=1) {
// 6_2
