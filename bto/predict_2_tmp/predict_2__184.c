...
double *t9 = t17;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s496) {
// 2_1
int __m496 = i + __s496 > P_ncols ? P_ncols - i : __s496;
double *t16 = t17 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m496; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s497) {
// 4_1
int __m497 = i + __s497 > P_ncols ? P_ncols - i : __s497;
double *t19 = t20 + i*P_ncols;
double *t18 = t10 + i*P_ncols;
for (j=0; j<__m497; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s498) {
// 6_1
int __m498 = i + __s498 > P_ncols ? P_ncols - i : __s498;
double *t23 = P + i*P_ncols;
double *t21 = t12 + i*P_ncols;
double *t22 = Q + i*P_ncols;
for (j=0; j<__m498; j+=1) {
// 6_2
