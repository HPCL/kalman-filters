...
double *t9 = t14;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s4327) {
// 2_1
int __m4327 = i + __s4327 > P_ncols ? P_ncols - i : __s4327;
double *t13 = t14 + i*P_ncols;
double *t12 = t8 + i*P_ncols;
for (j=0; j<__m4327; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s4328) {
// 4_1
int __m4328 = i + __s4328 > P_ncols ? P_ncols - i : __s4328;
double *t16 = t17 + i*P_ncols;
double *t15 = t10 + i*P_ncols;
for (j=0; j<__m4328; j+=1) {
// 4_2
