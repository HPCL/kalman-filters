...
double *t9 = t14;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s4349) {
// 2_1
int __m4349 = i + __s4349 > P_ncols ? P_ncols - i : __s4349;
double *t13 = t14 + i*P_ncols;
double *t12 = t8 + i*P_ncols;
for (j=0; j<__m4349; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s4350) {
// 4_1
int __m4350 = i + __s4350 > P_ncols ? P_ncols - i : __s4350;
double *t16 = t17 + i*P_ncols;
double *t15 = t10 + i*P_ncols;
for (j=0; j<__m4350; j+=1) {
// 4_2
