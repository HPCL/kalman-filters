...
double *t8 = A;
double *t12 = A;
for (i=0; i<P_ncols; i+=__s4376) {
// 2_1
int __m4376 = i + __s4376 > P_ncols ? P_ncols - i : __s4376;
double *t14 = t15 + i*P_ncols;
double *t13 = t8 + i*P_ncols;
for (j=0; j<__m4376; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s4377) {
// 4_1
int __m4377 = i + __s4377 > P_ncols ? P_ncols - i : __s4377;
double *t17 = t18 + i;
