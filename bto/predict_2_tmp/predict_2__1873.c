...
double *t11 = t20;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s4400) {
// 2_1
int __m4400 = i + __s4400 > P_ncols ? P_ncols - i : __s4400;
double *t19 = t20 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m4400; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s4402) {
// 6_1
int __m4402 = i + __s4402 > P_ncols ? P_ncols - i : __s4402;
double *t23 = P + i;
double *t21 = t12 + i;
double *t22 = Q + i;
