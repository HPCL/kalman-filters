...
double *t16 = malloc(sizeof(double)*__s4431*P_ncols);
double *t20 = malloc(sizeof(double)*P_ncols*P_ncols);
double *t12 = t20;
double *t11 = t20;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s4431) {
// 2_1
int __m4431 = i + __s4431 > P_ncols ? P_ncols - i : __s4431;
double *t19 = t20 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m4431; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s4433) {
// 6_1
int __m4433 = i + __s4433 > P_ncols ? P_ncols - i : __s4433;
double *t23 = P + i;
double *t21 = t12 + i;
double *t22 = Q + i;
