...
double *t8 = A;
double *t12 = A;
for (i=0; i<P_ncols; i+=__s510) {
// 2_1
int __m510 = i + __s510 > P_ncols ? P_ncols - i : __s510;
double *t17 = t18 + i*P_ncols;
double *t16 = t8 + i*P_ncols;
for (j=0; j<__m510; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s511) {
// 4_1
int __m511 = i + __s511 > P_ncols ? P_ncols - i : __s511;
double *t20 = t21 + i;
...
for (i=0; i<P_ncols; i+=__s512) {
// 6_1
int __m512 = i + __s512 > P_ncols ? P_ncols - i : __s512;
double *t24 = P + i;
double *t22 = t13 + i;
double *t23 = Q + i;
for (j=0; j<P_ncols; j+=1) {
