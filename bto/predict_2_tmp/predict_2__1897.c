...
for (i=0; i<P_ncols; i+=__s4452) {
// 4_1
int __m4452 = i + __s4452 > P_ncols ? P_ncols - i : __s4452;
double *t18 = t19 + i;
...
for (i=0; i<P_ncols; i+=__s4453) {
// 6_1
int __m4453 = i + __s4453 > P_ncols ? P_ncols - i : __s4453;
double *t22 = P + i;
double *t20 = t11 + i;
double *t21 = Q + i;
for (j=0; j<P_ncols; j+=1) {
