...
double *t9 = t15;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s537) {
// 2_1
int __m537 = i + __s537 > P_ncols ? P_ncols - i : __s537;
double *t14 = t15 + i*P_ncols;
double *t13 = t8 + i*P_ncols;
for (j=0; j<__m537; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s538) {
// 6_1
int __m538 = i + __s538 > P_ncols ? P_ncols - i : __s538;
double *t21 = P + i;
double *t19 = t10 + i;
double *t20 = Q + i;
for (j=0; j<P_ncols; j+=1) {
