...
double *t8 = A;
double *t12 = A;
for (i=0; i<P_ncols; i+=__s544) {
// 2_1
int __m544 = i + __s544 > P_ncols ? P_ncols - i : __s544;
double *t17 = t18 + i*P_ncols;
double *t16 = t8 + i*P_ncols;
for (j=0; j<__m544; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s545) {
// 4_1
int __m545 = i + __s545 > P_ncols ? P_ncols - i : __s545;
double *t20 = t21 + i;
...
for (i=0; i<P_ncols; i+=__s546) {
// 6_1
int __m546 = i + __s546 > P_ncols ? P_ncols - i : __s546;
double *t24 = P + i*P_ncols;
double *t22 = t13 + i*P_ncols;
double *t23 = Q + i*P_ncols;
for (j=0; j<__m546; j+=1) {
// 6_2
