...
double *t9 = t15;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s547) {
// 2_1
int __m547 = i + __s547 > P_ncols ? P_ncols - i : __s547;
double *t14 = t15 + i*P_ncols;
double *t13 = t8 + i*P_ncols;
for (j=0; j<__m547; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s548) {
// 6_1
int __m548 = i + __s548 > P_ncols ? P_ncols - i : __s548;
double *t21 = P + i*P_ncols;
double *t19 = t10 + i*P_ncols;
double *t20 = Q + i*P_ncols;
for (j=0; j<__m548; j+=1) {
// 6_2
