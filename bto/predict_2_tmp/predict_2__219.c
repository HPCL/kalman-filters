...
for (j=0; j<P_ncols; j+=__s617) {
// 2_2
int __m617 = j + __s617 > P_ncols ? P_ncols - j : __s617;
...
int nparts__s618 = 8;
int __s618;
if (nparts__s618 > 1 && P_ncols > nparts__s618) {
__s618 = P_ncols/nparts__s618;
// this will fail if P_ncols%nparts__s618+__s618 > nparts__s618
// which primarily effects small sizes
if (P_ncols%nparts__s618)
++__s618;
}
else {
__s618 = P_ncols;
...
double *t18 = malloc(sizeof(double)*nparts__s618*P_ncols*P_ncols);
double *t12 = t21;
double *t9 = t18;
double *t55 = t18;
double *t10 = A;
double *t8 = A;
predict_0_msg_t *predict_0 = malloc(sizeof(predict_0_msg_t)*nparts__s618);
pthread_t *threads_0 = malloc(sizeof(pthread_t)*nparts__s618);
disp = 0;
for (i=0,ii=0; i<P_ncols; i+=__s618,ii+=1) {
// 2_1
int __m618 = i + __s618 > P_ncols ? P_ncols - i : __s618;
double *t17 = t18 + ii*P_ncols*P_ncols;
double *t15 = t10 + i;
double *t16 = P + i*P_ncols;
predict_0[disp].P_ncols = P_ncols;
predict_0[disp].t16 = t16;
predict_0[disp].__m618 = __m618;
predict_0[disp].t15 = t15;
predict_0[disp].t17 = t17;
predict_0[disp].__s617 = __s617;
...
int __m618 = i + __s618 > P_ncols ? P_ncols - i : __s618;
if ((ii == 0)) {
for (__j = 0; __j < P_ncols; __j+=__s617) {
int __m617 = __j + __s617 > P_ncols ? P_ncols - __j : __s617;
for (__k = 0; __k < __m617; __k+=1) {
...
for (i=0; i<P_ncols; i+=__s619) {
// 6_1
int __m619 = i + __s619 > P_ncols ? P_ncols - i : __s619;
double *t24 = P + i*P_ncols;
double *t22 = t12 + i*P_ncols;
double *t23 = Q + i*P_ncols;
for (j=0; j<__m619; j+=1) {
// 6_2
