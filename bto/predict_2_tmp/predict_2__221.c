...
double *t10 = t19;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s625) {
// 2_1
int __m625 = i + __s625 > P_ncols ? P_ncols - i : __s625;
double *t13 = t8 + i;
...
for (i=0; i<P_ncols; i+=__s626) {
// 6_1
int __m626 = i + __s626 > P_ncols ? P_ncols - i : __s626;
double *t22 = P + i*P_ncols;
double *t20 = t10 + i*P_ncols;
double *t21 = Q + i*P_ncols;
for (j=0; j<__m626; j+=1) {
// 6_2
