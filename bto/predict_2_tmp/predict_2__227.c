...
double *t9 = t15;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s643) {
// 2_1
int __m643 = i + __s643 > P_ncols ? P_ncols - i : __s643;
double *t14 = t15 + i*P_ncols;
double *t13 = t8 + i*P_ncols;
for (j=0; j<__m643; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s644) {
// 6_1
int __m644 = i + __s644 > P_ncols ? P_ncols - i : __s644;
double *t21 = P + i;
double *t19 = t10 + i;
double *t20 = Q + i;
for (j=0; j<P_ncols; j+=1) {
