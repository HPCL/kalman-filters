...
double *t9 = t15;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s645) {
// 2_1
int __m645 = i + __s645 > P_ncols ? P_ncols - i : __s645;
double *t14 = t15 + i*P_ncols;
double *t13 = t8 + i*P_ncols;
for (j=0; j<__m645; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s646) {
// 6_1
int __m646 = i + __s646 > P_ncols ? P_ncols - i : __s646;
double *t21 = P + i*P_ncols;
double *t19 = t10 + i*P_ncols;
double *t20 = Q + i*P_ncols;
for (j=0; j<__m646; j+=1) {
// 6_2
