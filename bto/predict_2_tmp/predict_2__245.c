...
double *t9 = t15;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s706) {
// 2_1
int __m706 = i + __s706 > P_ncols ? P_ncols - i : __s706;
double *t14 = t15 + i*P_ncols;
double *t13 = t8 + i*P_ncols;
for (j=0; j<__m706; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s707) {
// 6_1
int __m707 = i + __s707 > P_ncols ? P_ncols - i : __s707;
double *t21 = P + i*P_ncols;
double *t19 = t10 + i*P_ncols;
double *t20 = Q + i*P_ncols;
for (j=0; j<__m707; j+=1) {
// 6_2
