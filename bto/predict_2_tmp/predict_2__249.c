...
double *t9 = t15;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s718) {
// 2_1
int __m718 = i + __s718 > P_ncols ? P_ncols - i : __s718;
double *t14 = t15 + i*P_ncols;
double *t13 = t8 + i*P_ncols;
for (j=0; j<__m718; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s719) {
// 6_1
int __m719 = i + __s719 > P_ncols ? P_ncols - i : __s719;
double *t21 = P + i*P_ncols;
double *t19 = t10 + i*P_ncols;
double *t20 = Q + i*P_ncols;
for (j=0; j<__m719; j+=1) {
// 6_2
