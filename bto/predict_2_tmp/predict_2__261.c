...
double *t8 = A;
double *t12 = A;
for (i=0; i<P_ncols; i+=__s754) {
// 2_1
int __m754 = i + __s754 > P_ncols ? P_ncols - i : __s754;
double *t17 = t18 + i*P_ncols;
double *t16 = t8 + i*P_ncols;
for (j=0; j<__m754; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s755) {
// 4_1
int __m755 = i + __s755 > P_ncols ? P_ncols - i : __s755;
double *t20 = t21 + i;
...
for (i=0; i<P_ncols; i+=__s756) {
// 6_1
int __m756 = i + __s756 > P_ncols ? P_ncols - i : __s756;
double *t24 = P + i*P_ncols;
double *t22 = t13 + i*P_ncols;
double *t23 = Q + i*P_ncols;
for (j=0; j<__m756; j+=1) {
// 6_2
