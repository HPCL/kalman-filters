...
double *t10 = t19;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s759) {
// 2_1
int __m759 = i + __s759 > P_ncols ? P_ncols - i : __s759;
double *t13 = t8 + i;
...
for (i=0; i<P_ncols; i+=__s760) {
// 6_1
int __m760 = i + __s760 > P_ncols ? P_ncols - i : __s760;
double *t22 = P + i*P_ncols;
double *t20 = t10 + i*P_ncols;
double *t21 = Q + i*P_ncols;
for (j=0; j<__m760; j+=1) {
// 6_2
