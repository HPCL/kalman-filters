...
double *t8 = A;
double *t12 = A;
for (i=0; i<P_ncols; i+=__s761) {
// 2_1
int __m761 = i + __s761 > P_ncols ? P_ncols - i : __s761;
double *t16 = t8 + i;
...
for (i=0; i<P_ncols; i+=__s762) {
// 4_1
int __m762 = i + __s762 > P_ncols ? P_ncols - i : __s762;
double *t20 = t10 + i;
double *t28 = t12 + i;
for (j=0; j<P_ncols; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s763) {
// 6_1
int __m763 = i + __s763 > P_ncols ? P_ncols - i : __s763;
double *t26 = P + i*P_ncols;
double *t24 = t13 + i*P_ncols;
double *t25 = Q + i*P_ncols;
for (j=0; j<__m763; j+=1) {
// 6_2
