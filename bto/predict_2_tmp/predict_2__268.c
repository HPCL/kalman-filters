...
double *t20 = malloc(sizeof(double)*P_ncols*__s773);
double *t18 = malloc(sizeof(double)*P_ncols*P_ncols);
double *t9 = t18;
double *t8 = A;
double *t12 = A;
for (i=0; i<P_ncols; i+=__s772) {
// 2_1
int __m772 = i + __s772 > P_ncols ? P_ncols - i : __s772;
double *t17 = t18 + i*P_ncols;
double *t16 = t8 + i*P_ncols;
for (j=0; j<__m772; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s773) {
// 4_1
int __m773 = i + __s773 > P_ncols ? P_ncols - i : __s773;
double *t24 = P + i;
double *t26 = t12 + i*P_ncols;
double *t23 = Q + i;
for (j=0; j<P_ncols; j+=1) {
// 4_2
double *t31 = t20 + j*__m773;
double *t30 = t9 + j*P_ncols;
for (k=0; k<__m773; k+=1) {
// 4_3
