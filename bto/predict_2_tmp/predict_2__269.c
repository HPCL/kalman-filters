...
double *t12 = A;
double *t9 = t18;
for (i=0; i<P_ncols; i+=__s775) {
// 2_1
int __m775 = i + __s775 > P_ncols ? P_ncols - i : __s775;
double *t17 = t18 + i;
double *t16 = P + i;
...
for (__zr__ = 0; __zr__ < __m775; ++__zr__) t28[__zr__] = 0.0;
for (k=0; k<P_ncols; k+=1) {
// 2_3
double *t38 = t16 + k*P_ncols;
for (l=0; l<__m775; l+=1) {
// 2_4
t28[l] += (t27[k]*t38[l]);
}
}
...
for (i=0; i<P_ncols; i+=__s776) {
// 4_1
int __m776 = i + __s776 > P_ncols ? P_ncols - i : __s776;
double *t20 = t21 + i;
...
for (i=0; i<P_ncols; i+=__s777) {
// 6_1
int __m777 = i + __s777 > P_ncols ? P_ncols - i : __s777;
double *t24 = P + i*P_ncols;
double *t22 = t13 + i*P_ncols;
double *t23 = Q + i*P_ncols;
for (j=0; j<__m777; j+=1) {
// 6_2
