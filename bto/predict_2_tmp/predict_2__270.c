...
double *t9 = t15;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s778) {
// 2_1
int __m778 = i + __s778 > P_ncols ? P_ncols - i : __s778;
double *t14 = t15 + i*P_ncols;
double *t13 = t8 + i*P_ncols;
for (j=0; j<__m778; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s779) {
// 6_1
int __m779 = i + __s779 > P_ncols ? P_ncols - i : __s779;
double *t21 = P + i*P_ncols;
double *t19 = t10 + i*P_ncols;
double *t20 = Q + i*P_ncols;
for (j=0; j<__m779; j+=1) {
// 6_2
