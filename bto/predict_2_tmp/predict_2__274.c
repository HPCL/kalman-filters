...
double *t9 = t15;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s790) {
// 2_1
int __m790 = i + __s790 > P_ncols ? P_ncols - i : __s790;
double *t14 = t15 + i*P_ncols;
double *t13 = t8 + i*P_ncols;
for (j=0; j<__m790; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s791) {
// 6_1
int __m791 = i + __s791 > P_ncols ? P_ncols - i : __s791;
double *t21 = P + i*P_ncols;
double *t19 = t10 + i*P_ncols;
double *t20 = Q + i*P_ncols;
for (j=0; j<__m791; j+=1) {
// 6_2
