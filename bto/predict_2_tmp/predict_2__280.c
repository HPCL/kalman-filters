...
double *t10 = t19;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s807) {
// 2_1
int __m807 = i + __s807 > P_ncols ? P_ncols - i : __s807;
double *t13 = t8 + i;
...
for (i=0; i<P_ncols; i+=__s808) {
// 6_1
int __m808 = i + __s808 > P_ncols ? P_ncols - i : __s808;
double *t22 = P + i*P_ncols;
double *t20 = t10 + i*P_ncols;
double *t21 = Q + i*P_ncols;
for (j=0; j<__m808; j+=1) {
// 6_2
