...
double *t8 = A;
double *t12 = A;
for (i=0; i<P_ncols; i+=__s809) {
// 2_1
int __m809 = i + __s809 > P_ncols ? P_ncols - i : __s809;
double *t16 = t8 + i;
...
for (i=0; i<P_ncols; i+=__s810) {
// 4_1
int __m810 = i + __s810 > P_ncols ? P_ncols - i : __s810;
double *t20 = t10 + i;
double *t28 = t12 + i;
for (j=0; j<P_ncols; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s811) {
// 6_1
int __m811 = i + __s811 > P_ncols ? P_ncols - i : __s811;
double *t26 = P + i*P_ncols;
double *t24 = t13 + i*P_ncols;
double *t25 = Q + i*P_ncols;
for (j=0; j<__m811; j+=1) {
// 6_2
