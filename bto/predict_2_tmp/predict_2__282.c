...
for (i=0; i<P_ncols; i+=__s812) {
// 4_1
int __m812 = i + __s812 > P_ncols ? P_ncols - i : __s812;
double *t18 = t19 + i;
...
for (i=0; i<P_ncols; i+=__s813) {
// 6_1
int __m813 = i + __s813 > P_ncols ? P_ncols - i : __s813;
double *t22 = P + i*P_ncols;
double *t20 = t11 + i*P_ncols;
double *t21 = Q + i*P_ncols;
for (j=0; j<__m813; j+=1) {
// 6_2
