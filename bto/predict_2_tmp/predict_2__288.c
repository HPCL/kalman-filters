...
double *t10 = t19;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s823) {
// 2_1
int __m823 = i + __s823 > P_ncols ? P_ncols - i : __s823;
double *t13 = t8 + i;
...
for (i=0; i<P_ncols; i+=__s824) {
// 6_1
int __m824 = i + __s824 > P_ncols ? P_ncols - i : __s824;
double *t22 = P + i*P_ncols;
double *t20 = t10 + i*P_ncols;
double *t21 = Q + i*P_ncols;
for (j=0; j<__m824; j+=1) {
// 6_2
