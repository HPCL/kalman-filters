...
double *t10 = t17;
double *t9 = t17;
for (i=0; i<P_ncols; i+=__s105) {
// 2_1
int __m105 = i + __s105 > P_ncols ? P_ncols - i : __s105;
double *t16 = t17 + i;
double *t15 = P + i;
...
for (__zr__ = 0; __zr__ < __m105; ++__zr__) t26[__zr__] = 0.0;
for (k=0; k<P_ncols; k+=1) {
// 2_3
double *t36 = t15 + k*P_ncols;
for (l=0; l<__m105; l+=1) {
// 2_4
t26[l] += (t25[k]*t36[l]);
}
}
...
for (i=0; i<P_ncols; i+=__s106) {
// 4_1
int __m106 = i + __s106 > P_ncols ? P_ncols - i : __s106;
double *t19 = t20 + i*P_ncols;
double *t18 = t10 + i*P_ncols;
for (j=0; j<__m106; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s107) {
// 6_1
int __m107 = i + __s107 > P_ncols ? P_ncols - i : __s107;
double *t23 = P + i*P_ncols;
double *t21 = t12 + i*P_ncols;
double *t22 = Q + i*P_ncols;
for (j=0; j<__m107; j+=1) {
// 6_2
