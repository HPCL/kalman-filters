...
double *t8 = A;
double *t12 = A;
for (i=0; i<P_ncols; i+=__s825) {
// 2_1
int __m825 = i + __s825 > P_ncols ? P_ncols - i : __s825;
double *t16 = t8 + i;
...
for (i=0; i<P_ncols; i+=__s826) {
// 4_1
int __m826 = i + __s826 > P_ncols ? P_ncols - i : __s826;
double *t20 = t10 + i;
double *t28 = t12 + i;
for (j=0; j<P_ncols; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s827) {
// 6_1
int __m827 = i + __s827 > P_ncols ? P_ncols - i : __s827;
double *t26 = P + i*P_ncols;
double *t24 = t13 + i*P_ncols;
double *t25 = Q + i*P_ncols;
for (j=0; j<__m827; j+=1) {
// 6_2
