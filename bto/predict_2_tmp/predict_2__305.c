...
double *t8 = A;
double *t12 = A;
for (i=0; i<P_ncols; i+=__s858) {
// 2_1
int __m858 = i + __s858 > P_ncols ? P_ncols - i : __s858;
double *t13 = t8 + i;
...
for (i=0; i<P_ncols; i+=__s859) {
// 4_1
int __m859 = i + __s859 > P_ncols ? P_ncols - i : __s859;
double *t17 = t10 + i;
double *t25 = t12 + i;
for (j=0; j<P_ncols; j+=1) {
// 4_2
