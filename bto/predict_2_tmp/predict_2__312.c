...
double *t8 = A;
double *t12 = A;
for (i=0; i<P_ncols; i+=__s871) {
// 2_1
int __m871 = i + __s871 > P_ncols ? P_ncols - i : __s871;
double *t16 = t8 + i;
...
for (i=0; i<P_ncols; i+=__s872) {
// 4_1
int __m872 = i + __s872 > P_ncols ? P_ncols - i : __s872;
double *t20 = t10 + i;
double *t28 = t12 + i;
for (j=0; j<P_ncols; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s873) {
// 6_1
int __m873 = i + __s873 > P_ncols ? P_ncols - i : __s873;
double *t26 = P + i*P_ncols;
double *t24 = t13 + i*P_ncols;
double *t25 = Q + i*P_ncols;
for (j=0; j<__m873; j+=1) {
// 6_2
