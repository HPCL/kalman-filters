...
for (i=0; i<P_ncols; i+=__s880) {
// 4_1
int __m880 = i + __s880 > P_ncols ? P_ncols - i : __s880;
double *t18 = t19 + i;
...
for (i=0; i<P_ncols; i+=__s881) {
// 6_1
int __m881 = i + __s881 > P_ncols ? P_ncols - i : __s881;
double *t22 = P + i*P_ncols;
double *t20 = t11 + i*P_ncols;
double *t21 = Q + i*P_ncols;
for (j=0; j<__m881; j+=1) {
// 6_2
