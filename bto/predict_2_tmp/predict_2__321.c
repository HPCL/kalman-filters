...
for (i=0; i<P_ncols; i+=__s890) {
// 4_1
int __m890 = i + __s890 > P_ncols ? P_ncols - i : __s890;
double *t17 = t8 + i;
double *t25 = t10 + i;
for (j=0; j<P_ncols; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s891) {
// 6_1
int __m891 = i + __s891 > P_ncols ? P_ncols - i : __s891;
double *t23 = P + i*P_ncols;
double *t21 = t11 + i*P_ncols;
double *t22 = Q + i*P_ncols;
for (j=0; j<__m891; j+=1) {
// 6_2
