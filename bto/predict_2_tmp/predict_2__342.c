...
double *t8 = A;
double *t12 = A;
for (i=0; i<P_ncols; i+=__s930) {
// 2_1
int __m930 = i + __s930 > P_ncols ? P_ncols - i : __s930;
double *t17 = t18 + i*P_ncols;
double *t16 = t8 + i*P_ncols;
for (j=0; j<__m930; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s931) {
// 4_1
int __m931 = i + __s931 > P_ncols ? P_ncols - i : __s931;
double *t20 = t21 + i;
...
for (i=0; i<P_ncols; i+=__s932) {
// 6_1
int __m932 = i + __s932 > P_ncols ? P_ncols - i : __s932;
double *t24 = P + i*P_ncols;
double *t22 = t13 + i*P_ncols;
double *t23 = Q + i*P_ncols;
for (j=0; j<__m932; j+=1) {
// 6_2
