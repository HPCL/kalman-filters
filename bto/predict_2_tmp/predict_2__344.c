...
double *t8 = A;
double *t12 = A;
for (i=0; i<P_ncols; i+=__s935) {
// 2_1
int __m935 = i + __s935 > P_ncols ? P_ncols - i : __s935;
double *t16 = t8 + i;
...
for (i=0; i<P_ncols; i+=__s936) {
// 4_1
int __m936 = i + __s936 > P_ncols ? P_ncols - i : __s936;
double *t20 = t10 + i;
double *t28 = t12 + i;
for (j=0; j<P_ncols; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s937) {
// 6_1
int __m937 = i + __s937 > P_ncols ? P_ncols - i : __s937;
double *t26 = P + i*P_ncols;
double *t24 = t13 + i*P_ncols;
double *t25 = Q + i*P_ncols;
for (j=0; j<__m937; j+=1) {
// 6_2
