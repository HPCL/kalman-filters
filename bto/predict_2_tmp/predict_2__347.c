...
double *t12 = A;
double *t9 = t18;
for (i=0; i<P_ncols; i+=__s947) {
// 2_1
int __m947 = i + __s947 > P_ncols ? P_ncols - i : __s947;
double *t17 = t18 + i;
double *t16 = P + i;
...
for (__zr__ = 0; __zr__ < __m947; ++__zr__) t28[__zr__] = 0.0;
for (k=0; k<P_ncols; k+=1) {
// 2_3
double *t38 = t16 + k*P_ncols;
for (l=0; l<__m947; l+=1) {
// 2_4
t28[l] += (t27[k]*t38[l]);
}
}
...
for (i=0; i<P_ncols; i+=__s948) {
// 4_1
int __m948 = i + __s948 > P_ncols ? P_ncols - i : __s948;
double *t20 = t21 + i;
...
for (i=0; i<P_ncols; i+=__s949) {
// 6_1
int __m949 = i + __s949 > P_ncols ? P_ncols - i : __s949;
double *t24 = P + i*P_ncols;
double *t22 = t13 + i*P_ncols;
double *t23 = Q + i*P_ncols;
for (j=0; j<__m949; j+=1) {
// 6_2
