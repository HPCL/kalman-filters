...
double *t10 = t19;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s955) {
// 2_1
int __m955 = i + __s955 > P_ncols ? P_ncols - i : __s955;
double *t13 = t8 + i;
...
for (i=0; i<P_ncols; i+=__s956) {
// 6_1
int __m956 = i + __s956 > P_ncols ? P_ncols - i : __s956;
double *t22 = P + i*P_ncols;
double *t20 = t10 + i*P_ncols;
double *t21 = Q + i*P_ncols;
for (j=0; j<__m956; j+=1) {
// 6_2
