...
double *t8 = A;
double *t12 = A;
for (i=0; i<P_ncols; i+=__s960) {
// 2_1
int __m960 = i + __s960 > P_ncols ? P_ncols - i : __s960;
double *t16 = t8 + i;
...
for (i=0; i<P_ncols; i+=__s961) {
// 4_1
int __m961 = i + __s961 > P_ncols ? P_ncols - i : __s961;
double *t21 = t22 + i;
...
for (i=0; i<P_ncols; i+=__s962) {
// 6_1
int __m962 = i + __s962 > P_ncols ? P_ncols - i : __s962;
double *t25 = P + i*P_ncols;
double *t23 = t13 + i*P_ncols;
double *t24 = Q + i*P_ncols;
for (j=0; j<__m962; j+=1) {
// 6_2
