...
for (i=0; i<P_ncols; i+=__s964) {
// 4_1
int __m964 = i + __s964 > P_ncols ? P_ncols - i : __s964;
double *t18 = t19 + i;
...
for (i=0; i<P_ncols; i+=__s965) {
// 6_1
int __m965 = i + __s965 > P_ncols ? P_ncols - i : __s965;
double *t22 = P + i*P_ncols;
double *t20 = t11 + i*P_ncols;
double *t21 = Q + i*P_ncols;
for (j=0; j<__m965; j+=1) {
// 6_2
