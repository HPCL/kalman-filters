...
for (i=0; i<P_ncols; i+=__s977) {
// 4_1
int __m977 = i + __s977 > P_ncols ? P_ncols - i : __s977;
double *t17 = t18 + i*P_ncols;
double *t16 = t8 + i*P_ncols;
for (j=0; j<__m977; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s978) {
// 6_1
int __m978 = i + __s978 > P_ncols ? P_ncols - i : __s978;
double *t21 = P + i*P_ncols;
double *t19 = t10 + i*P_ncols;
double *t20 = Q + i*P_ncols;
for (j=0; j<__m978; j+=1) {
// 6_2
