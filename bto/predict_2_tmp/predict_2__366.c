...
double *t8 = A;
double *t12 = A;
for (i=0; i<P_ncols; i+=__s987) {
// 2_1
int __m987 = i + __s987 > P_ncols ? P_ncols - i : __s987;
double *t14 = t15 + i*P_ncols;
double *t13 = t8 + i*P_ncols;
for (j=0; j<__m987; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s988) {
// 4_1
int __m988 = i + __s988 > P_ncols ? P_ncols - i : __s988;
double *t17 = t18 + i;
