...
double *t10 = t15;
double *t9 = t15;
for (i=0; i<P_ncols; i+=__s996) {
// 2_1
int __m996 = i + __s996 > P_ncols ? P_ncols - i : __s996;
double *t14 = t15 + i;
double *t13 = P + i;
...
for (__zr__ = 0; __zr__ < __m996; ++__zr__) t26[__zr__] = 0.0;
for (k=0; k<P_ncols; k+=1) {
// 2_3
double *t36 = t13 + k*P_ncols;
for (l=0; l<__m996; l+=1) {
// 2_4
t26[l] += (t25[k]*t36[l]);
}
}
...
for (i=0; i<P_ncols; i+=__s997) {
// 4_1
int __m997 = i + __s997 > P_ncols ? P_ncols - i : __s997;
double *t16 = t10 + i;
double *t24 = t12 + i;
for (j=0; j<P_ncols; j+=1) {
// 4_2
