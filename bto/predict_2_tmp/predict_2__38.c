...
double *t9 = t15;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s132) {
// 2_1
int __m132 = i + __s132 > P_ncols ? P_ncols - i : __s132;
double *t14 = t15 + i*P_ncols;
double *t13 = t8 + i*P_ncols;
for (j=0; j<__m132; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s133) {
// 6_1
int __m133 = i + __s133 > P_ncols ? P_ncols - i : __s133;
double *t21 = P + i*P_ncols;
double *t19 = t10 + i*P_ncols;
double *t20 = Q + i*P_ncols;
for (j=0; j<__m133; j+=1) {
// 6_2
