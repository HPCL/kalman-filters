...
double *t9 = t14;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s1056) {
// 2_1
int __m1056 = i + __s1056 > P_ncols ? P_ncols - i : __s1056;
double *t13 = t14 + i*P_ncols;
double *t12 = t8 + i*P_ncols;
for (j=0; j<__m1056; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s1057) {
// 4_1
int __m1057 = i + __s1057 > P_ncols ? P_ncols - i : __s1057;
double *t16 = t17 + i*P_ncols;
double *t15 = t10 + i*P_ncols;
for (j=0; j<__m1057; j+=1) {
// 4_2
