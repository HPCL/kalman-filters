...
double *t10 = t17;
double *t9 = t17;
for (i=0; i<P_ncols; i+=__s1075) {
// 2_1
int __m1075 = i + __s1075 > P_ncols ? P_ncols - i : __s1075;
double *t16 = t17 + i;
double *t15 = P + i;
...
for (__zr__ = 0; __zr__ < __m1075; ++__zr__) t26[__zr__] = 0.0;
for (k=0; k<P_ncols; k+=1) {
// 2_3
double *t36 = t15 + k*P_ncols;
for (l=0; l<__m1075; l+=1) {
// 2_4
t26[l] += (t25[k]*t36[l]);
}
}
...
for (i=0; i<P_ncols; i+=__s1076) {
// 4_1
int __m1076 = i + __s1076 > P_ncols ? P_ncols - i : __s1076;
double *t19 = t20 + i*P_ncols;
double *t18 = t10 + i*P_ncols;
for (j=0; j<__m1076; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s1077) {
// 6_1
int __m1077 = i + __s1077 > P_ncols ? P_ncols - i : __s1077;
double *t23 = P + i*P_ncols;
double *t21 = t12 + i*P_ncols;
double *t22 = Q + i*P_ncols;
for (j=0; j<__m1077; j+=1) {
// 6_2
