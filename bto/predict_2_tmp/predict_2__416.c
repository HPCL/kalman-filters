...
double *t12 = A;
double *t9 = t18;
for (i=0; i<P_ncols; i+=__s1099) {
// 2_1
int __m1099 = i + __s1099 > P_ncols ? P_ncols - i : __s1099;
double *t17 = t18 + i;
double *t16 = P + i;
...
for (__zr__ = 0; __zr__ < __m1099; ++__zr__) t28[__zr__] = 0.0;
for (k=0; k<P_ncols; k+=1) {
// 2_3
double *t38 = t16 + k*P_ncols;
for (l=0; l<__m1099; l+=1) {
// 2_4
t28[l] += (t27[k]*t38[l]);
}
}
...
for (i=0; i<P_ncols; i+=__s1100) {
// 4_1
int __m1100 = i + __s1100 > P_ncols ? P_ncols - i : __s1100;
double *t20 = t21 + i;
...
for (i=0; i<P_ncols; i+=__s1101) {
// 6_1
int __m1101 = i + __s1101 > P_ncols ? P_ncols - i : __s1101;
double *t24 = P + i*P_ncols;
double *t22 = t13 + i*P_ncols;
double *t23 = Q + i*P_ncols;
for (j=0; j<__m1101; j+=1) {
// 6_2
