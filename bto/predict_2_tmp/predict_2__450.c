...
for (i=0; i<P_ncols; i+=__s1184) {
// 4_1
int __m1184 = i + __s1184 > P_ncols ? P_ncols - i : __s1184;
double *t17 = t8 + i;
double *t25 = t10 + i;
for (j=0; j<P_ncols; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s1185) {
// 6_1
int __m1185 = i + __s1185 > P_ncols ? P_ncols - i : __s1185;
double *t23 = P + i;
double *t21 = t11 + i;
double *t22 = Q + i;
for (j=0; j<P_ncols; j+=1) {
