...
for (i=0; i<P_ncols; i+=__s1203) {
// 4_1
int __m1203 = i + __s1203 > P_ncols ? P_ncols - i : __s1203;
double *t17 = t18 + i*P_ncols;
double *t16 = t8 + i*P_ncols;
for (j=0; j<__m1203; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s1204) {
// 6_1
int __m1204 = i + __s1204 > P_ncols ? P_ncols - i : __s1204;
double *t21 = P + i;
double *t19 = t10 + i;
double *t20 = Q + i;
for (j=0; j<P_ncols; j+=1) {
