...
double *t10 = t18;
double *t9 = t15;
for (i=0; i<P_ncols; i+=__s1205) {
// 2_1
int __m1205 = i + __s1205 > P_ncols ? P_ncols - i : __s1205;
double *t14 = t15 + i;
double *t13 = P + i;
...
for (__zr__ = 0; __zr__ < __m1205; ++__zr__) t24[__zr__] = 0.0;
for (k=0; k<P_ncols; k+=1) {
// 2_3
double *t35 = t13 + k*P_ncols;
for (l=0; l<__m1205; l+=1) {
// 2_4
t24[l] += (t23[k]*t35[l]);
}
}
...
for (i=0; i<P_ncols; i+=__s1206) {
// 6_1
int __m1206 = i + __s1206 > P_ncols ? P_ncols - i : __s1206;
double *t21 = P + i;
double *t19 = t10 + i;
double *t20 = Q + i;
for (j=0; j<P_ncols; j+=1) {
