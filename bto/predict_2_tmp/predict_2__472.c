...
double *t9 = t15;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s1243) {
// 2_1
int __m1243 = i + __s1243 > P_ncols ? P_ncols - i : __s1243;
double *t14 = t15 + i*P_ncols;
double *t13 = t8 + i*P_ncols;
for (j=0; j<__m1243; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s1244) {
// 6_1
int __m1244 = i + __s1244 > P_ncols ? P_ncols - i : __s1244;
double *t21 = P + i;
double *t19 = t10 + i;
double *t20 = Q + i;
for (j=0; j<P_ncols; j+=1) {
