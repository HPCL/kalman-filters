...
double *t8 = A;
double *t12 = A;
for (i=0; i<P_ncols; i+=__s1266) {
// 2_1
int __m1266 = i + __s1266 > P_ncols ? P_ncols - i : __s1266;
double *t17 = t18 + i*P_ncols;
double *t16 = t8 + i*P_ncols;
for (j=0; j<__m1266; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s1267) {
// 4_1
int __m1267 = i + __s1267 > P_ncols ? P_ncols - i : __s1267;
double *t20 = t21 + i;
...
for (i=0; i<P_ncols; i+=__s1268) {
// 6_1
int __m1268 = i + __s1268 > P_ncols ? P_ncols - i : __s1268;
double *t24 = P + i*P_ncols;
double *t22 = t13 + i*P_ncols;
double *t23 = Q + i*P_ncols;
for (j=0; j<__m1268; j+=1) {
// 6_2
