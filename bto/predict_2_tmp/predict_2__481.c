...
double *t9 = t17;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s1269) {
// 2_1
int __m1269 = i + __s1269 > P_ncols ? P_ncols - i : __s1269;
double *t16 = t17 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m1269; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s1270) {
// 4_1
int __m1270 = i + __s1270 > P_ncols ? P_ncols - i : __s1270;
double *t19 = t20 + i*P_ncols;
double *t18 = t10 + i*P_ncols;
for (j=0; j<__m1270; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s1271) {
// 6_1
int __m1271 = i + __s1271 > P_ncols ? P_ncols - i : __s1271;
double *t23 = P + i;
double *t21 = t12 + i;
double *t22 = Q + i;
