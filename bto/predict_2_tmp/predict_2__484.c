...
double *t9 = t15;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s1276) {
// 2_1
int __m1276 = i + __s1276 > P_ncols ? P_ncols - i : __s1276;
double *t14 = t15 + i*P_ncols;
double *t13 = t8 + i*P_ncols;
for (j=0; j<__m1276; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s1277) {
// 6_1
int __m1277 = i + __s1277 > P_ncols ? P_ncols - i : __s1277;
double *t21 = P + i;
double *t19 = t10 + i;
double *t20 = Q + i;
for (j=0; j<P_ncols; j+=1) {
