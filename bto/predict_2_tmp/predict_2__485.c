...
double *t9 = t17;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s1278) {
// 2_1
int __m1278 = i + __s1278 > P_ncols ? P_ncols - i : __s1278;
double *t16 = t17 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m1278; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s1279) {
// 4_1
int __m1279 = i + __s1279 > P_ncols ? P_ncols - i : __s1279;
double *t19 = t20 + i*P_ncols;
double *t18 = t10 + i*P_ncols;
for (j=0; j<__m1279; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s1280) {
// 6_1
int __m1280 = i + __s1280 > P_ncols ? P_ncols - i : __s1280;
double *t23 = P + i;
double *t21 = t12 + i;
double *t22 = Q + i;
