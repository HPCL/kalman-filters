...
double *t9 = t17;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s1301) {
// 2_1
int __m1301 = i + __s1301 > P_ncols ? P_ncols - i : __s1301;
double *t16 = t17 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m1301; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s1302) {
// 4_1
int __m1302 = i + __s1302 > P_ncols ? P_ncols - i : __s1302;
double *t19 = t20 + i*P_ncols;
double *t18 = t10 + i*P_ncols;
for (j=0; j<__m1302; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s1303) {
// 6_1
int __m1303 = i + __s1303 > P_ncols ? P_ncols - i : __s1303;
double *t23 = P + i;
double *t21 = t12 + i;
double *t22 = Q + i;
