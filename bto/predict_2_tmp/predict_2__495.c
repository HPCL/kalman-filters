...
double *t9 = t17;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s1307) {
// 2_1
int __m1307 = i + __s1307 > P_ncols ? P_ncols - i : __s1307;
double *t16 = t17 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m1307; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s1308) {
// 4_1
int __m1308 = i + __s1308 > P_ncols ? P_ncols - i : __s1308;
double *t19 = t20 + i*P_ncols;
double *t18 = t10 + i*P_ncols;
for (j=0; j<__m1308; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s1309) {
// 6_1
int __m1309 = i + __s1309 > P_ncols ? P_ncols - i : __s1309;
double *t23 = P + i;
double *t21 = t12 + i;
double *t22 = Q + i;
