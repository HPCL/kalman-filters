...
for (i=0; i<P_ncols; i+=__s1310) {
// 4_1
int __m1310 = i + __s1310 > P_ncols ? P_ncols - i : __s1310;
double *t18 = t19 + i;
...
for (i=0; i<P_ncols; i+=__s1311) {
// 6_1
int __m1311 = i + __s1311 > P_ncols ? P_ncols - i : __s1311;
double *t22 = P + i;
double *t20 = t11 + i;
double *t21 = Q + i;
for (j=0; j<P_ncols; j+=1) {
