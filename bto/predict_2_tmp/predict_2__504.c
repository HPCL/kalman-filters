...
double *t9 = t17;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s1323) {
// 2_1
int __m1323 = i + __s1323 > P_ncols ? P_ncols - i : __s1323;
double *t16 = t17 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m1323; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s1324) {
// 4_1
int __m1324 = i + __s1324 > P_ncols ? P_ncols - i : __s1324;
double *t19 = t20 + i*P_ncols;
double *t18 = t10 + i*P_ncols;
for (j=0; j<__m1324; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s1325) {
// 6_1
int __m1325 = i + __s1325 > P_ncols ? P_ncols - i : __s1325;
double *t23 = P + i;
double *t21 = t12 + i;
double *t22 = Q + i;
