...
for (i=0; i<P_ncols; i+=__s1330) {
// 4_1
int __m1330 = i + __s1330 > P_ncols ? P_ncols - i : __s1330;
double *t17 = t18 + i*P_ncols;
double *t16 = t8 + i*P_ncols;
for (j=0; j<__m1330; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s1331) {
// 6_1
int __m1331 = i + __s1331 > P_ncols ? P_ncols - i : __s1331;
double *t21 = P + i;
double *t19 = t10 + i;
double *t20 = Q + i;
for (j=0; j<P_ncols; j+=1) {
