...
double *t8 = A;
double *t12 = A;
for (i=0; i<P_ncols; i+=__s1336) {
// 2_1
int __m1336 = i + __s1336 > P_ncols ? P_ncols - i : __s1336;
double *t17 = t18 + i*P_ncols;
double *t16 = t8 + i*P_ncols;
for (j=0; j<__m1336; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s1337) {
// 4_1
int __m1337 = i + __s1337 > P_ncols ? P_ncols - i : __s1337;
double *t20 = t21 + i;
...
for (i=0; i<P_ncols; i+=__s1338) {
// 6_1
int __m1338 = i + __s1338 > P_ncols ? P_ncols - i : __s1338;
double *t24 = P + i;
double *t22 = t13 + i;
double *t23 = Q + i;
for (j=0; j<P_ncols; j+=1) {
