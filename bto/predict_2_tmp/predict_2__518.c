...
double *t9 = t17;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s1341) {
// 2_1
int __m1341 = i + __s1341 > P_ncols ? P_ncols - i : __s1341;
double *t16 = t17 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m1341; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s1342) {
// 4_1
int __m1342 = i + __s1342 > P_ncols ? P_ncols - i : __s1342;
double *t19 = t20 + i*P_ncols;
double *t18 = t10 + i*P_ncols;
for (j=0; j<__m1342; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s1343) {
// 6_1
int __m1343 = i + __s1343 > P_ncols ? P_ncols - i : __s1343;
double *t23 = P + i*P_ncols;
double *t21 = t12 + i*P_ncols;
double *t22 = Q + i*P_ncols;
for (j=0; j<__m1343; j+=1) {
// 6_2
