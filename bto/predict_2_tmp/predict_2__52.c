...
double *t9 = t17;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s171) {
// 2_1
int __m171 = i + __s171 > P_ncols ? P_ncols - i : __s171;
double *t16 = t17 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m171; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s172) {
// 4_1
int __m172 = i + __s172 > P_ncols ? P_ncols - i : __s172;
double *t19 = t20 + i*P_ncols;
double *t18 = t10 + i*P_ncols;
for (j=0; j<__m172; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s173) {
// 6_1
int __m173 = i + __s173 > P_ncols ? P_ncols - i : __s173;
double *t23 = P + i*P_ncols;
double *t21 = t12 + i*P_ncols;
double *t22 = Q + i*P_ncols;
for (j=0; j<__m173; j+=1) {
// 6_2
