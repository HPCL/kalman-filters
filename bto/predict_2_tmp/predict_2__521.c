...
double *t9 = t14;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s1347) {
// 2_1
int __m1347 = i + __s1347 > P_ncols ? P_ncols - i : __s1347;
double *t13 = t14 + i*P_ncols;
double *t12 = t8 + i*P_ncols;
for (j=0; j<__m1347; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s1348) {
// 4_1
int __m1348 = i + __s1348 > P_ncols ? P_ncols - i : __s1348;
double *t16 = t17 + i*P_ncols;
double *t15 = t10 + i*P_ncols;
for (j=0; j<__m1348; j+=1) {
// 4_2
