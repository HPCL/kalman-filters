...
double *t9 = t14;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s1366) {
// 2_1
int __m1366 = i + __s1366 > P_ncols ? P_ncols - i : __s1366;
double *t13 = t14 + i*P_ncols;
double *t12 = t8 + i*P_ncols;
for (j=0; j<__m1366; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s1367) {
// 4_1
int __m1367 = i + __s1367 > P_ncols ? P_ncols - i : __s1367;
double *t16 = t17 + i*P_ncols;
double *t15 = t10 + i*P_ncols;
for (j=0; j<__m1367; j+=1) {
// 4_2
