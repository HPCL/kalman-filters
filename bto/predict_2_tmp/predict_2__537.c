...
double *t9 = t15;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s1383) {
// 2_1
int __m1383 = i + __s1383 > P_ncols ? P_ncols - i : __s1383;
double *t14 = t15 + i*P_ncols;
double *t13 = t8 + i*P_ncols;
for (j=0; j<__m1383; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s1384) {
// 6_1
int __m1384 = i + __s1384 > P_ncols ? P_ncols - i : __s1384;
double *t21 = P + i;
double *t19 = t10 + i;
double *t20 = Q + i;
for (j=0; j<P_ncols; j+=1) {
