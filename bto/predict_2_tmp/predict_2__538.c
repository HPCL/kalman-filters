...
double *t9 = t17;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s1385) {
// 2_1
int __m1385 = i + __s1385 > P_ncols ? P_ncols - i : __s1385;
double *t16 = t17 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m1385; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s1386) {
// 4_1
int __m1386 = i + __s1386 > P_ncols ? P_ncols - i : __s1386;
double *t19 = t20 + i*P_ncols;
double *t18 = t10 + i*P_ncols;
for (j=0; j<__m1386; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s1387) {
// 6_1
int __m1387 = i + __s1387 > P_ncols ? P_ncols - i : __s1387;
double *t23 = P + i;
double *t21 = t12 + i;
double *t22 = Q + i;
