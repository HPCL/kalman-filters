...
for (i=0; i<P_ncols; i+=__s1388) {
// 4_1
int __m1388 = i + __s1388 > P_ncols ? P_ncols - i : __s1388;
double *t17 = t18 + i*P_ncols;
double *t16 = t8 + i*P_ncols;
for (j=0; j<__m1388; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s1389) {
// 6_1
int __m1389 = i + __s1389 > P_ncols ? P_ncols - i : __s1389;
double *t21 = P + i*P_ncols;
double *t19 = t10 + i*P_ncols;
double *t20 = Q + i*P_ncols;
for (j=0; j<__m1389; j+=1) {
// 6_2
