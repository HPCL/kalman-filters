...
for (i=0; i<P_ncols; i+=__s1404) {
// 4_1
int __m1404 = i + __s1404 > P_ncols ? P_ncols - i : __s1404;
double *t18 = t19 + i;
...
for (i=0; i<P_ncols; i+=__s1405) {
// 6_1
int __m1405 = i + __s1405 > P_ncols ? P_ncols - i : __s1405;
double *t22 = P + i;
double *t20 = t11 + i;
double *t21 = Q + i;
for (j=0; j<P_ncols; j+=1) {
