...
double *t9 = t15;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s1406) {
// 2_1
int __m1406 = i + __s1406 > P_ncols ? P_ncols - i : __s1406;
double *t14 = t15 + i*P_ncols;
double *t13 = t8 + i*P_ncols;
for (j=0; j<__m1406; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s1407) {
// 6_1
int __m1407 = i + __s1407 > P_ncols ? P_ncols - i : __s1407;
double *t21 = P + i*P_ncols;
double *t19 = t10 + i*P_ncols;
double *t20 = Q + i*P_ncols;
for (j=0; j<__m1407; j+=1) {
// 6_2
