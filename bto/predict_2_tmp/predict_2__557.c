...
for (i=0; i<P_ncols; i+=__s1414) {
// 4_1
int __m1414 = i + __s1414 > P_ncols ? P_ncols - i : __s1414;
double *t18 = t19 + i;
...
for (i=0; i<P_ncols; i+=__s1415) {
// 6_1
int __m1415 = i + __s1415 > P_ncols ? P_ncols - i : __s1415;
double *t22 = P + i;
double *t20 = t11 + i;
double *t21 = Q + i;
for (j=0; j<P_ncols; j+=1) {
