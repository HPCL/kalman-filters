...
double *t16 = malloc(sizeof(double)*__s1417*P_ncols);
double *t20 = malloc(sizeof(double)*P_ncols*P_ncols);
double *t12 = t20;
double *t11 = t20;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s1417) {
// 2_1
int __m1417 = i + __s1417 > P_ncols ? P_ncols - i : __s1417;
double *t19 = t20 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m1417; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s1419) {
// 6_1
int __m1419 = i + __s1419 > P_ncols ? P_ncols - i : __s1419;
double *t23 = P + i*P_ncols;
double *t21 = t12 + i*P_ncols;
double *t22 = Q + i*P_ncols;
for (j=0; j<__m1419; j+=1) {
// 6_2
