...
for (i=0; i<P_ncols; i+=__s1451) {
// 4_1
int __m1451 = i + __s1451 > P_ncols ? P_ncols - i : __s1451;
double *t18 = t19 + i;
...
for (i=0; i<P_ncols; i+=__s1452) {
// 6_1
int __m1452 = i + __s1452 > P_ncols ? P_ncols - i : __s1452;
double *t22 = P + i;
double *t20 = t11 + i;
double *t21 = Q + i;
for (j=0; j<P_ncols; j+=1) {
