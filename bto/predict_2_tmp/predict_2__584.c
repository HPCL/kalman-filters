...
double *t8 = A;
double *t12 = A;
for (i=0; i<P_ncols; i+=__s1458) {
// 2_1
int __m1458 = i + __s1458 > P_ncols ? P_ncols - i : __s1458;
double *t16 = t8 + i;
...
for (i=0; i<P_ncols; i+=__s1459) {
// 4_1
int __m1459 = i + __s1459 > P_ncols ? P_ncols - i : __s1459;
double *t21 = t22 + i;
...
for (i=0; i<P_ncols; i+=__s1460) {
// 6_1
int __m1460 = i + __s1460 > P_ncols ? P_ncols - i : __s1460;
double *t25 = P + i;
double *t23 = t13 + i;
double *t24 = Q + i;
for (j=0; j<P_ncols; j+=1) {
