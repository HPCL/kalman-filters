...
double *t9 = t17;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s1467) {
// 2_1
int __m1467 = i + __s1467 > P_ncols ? P_ncols - i : __s1467;
double *t16 = t17 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m1467; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s1468) {
// 4_1
int __m1468 = i + __s1468 > P_ncols ? P_ncols - i : __s1468;
double *t19 = t20 + i*P_ncols;
double *t18 = t10 + i*P_ncols;
for (j=0; j<__m1468; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s1469) {
// 6_1
int __m1469 = i + __s1469 > P_ncols ? P_ncols - i : __s1469;
double *t23 = P + i*P_ncols;
double *t21 = t12 + i*P_ncols;
double *t22 = Q + i*P_ncols;
for (j=0; j<__m1469; j+=1) {
// 6_2
