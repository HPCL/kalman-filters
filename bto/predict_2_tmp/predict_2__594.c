...
double *t10 = t19;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s1478) {
// 2_1
int __m1478 = i + __s1478 > P_ncols ? P_ncols - i : __s1478;
double *t13 = t8 + i;
...
for (i=0; i<P_ncols; i+=__s1479) {
// 6_1
int __m1479 = i + __s1479 > P_ncols ? P_ncols - i : __s1479;
double *t22 = P + i;
double *t20 = t10 + i;
double *t21 = Q + i;
for (j=0; j<P_ncols; j+=1) {
