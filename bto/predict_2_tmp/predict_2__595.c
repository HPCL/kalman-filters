...
double *t10 = t19;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s1480) {
// 2_1
int __m1480 = i + __s1480 > P_ncols ? P_ncols - i : __s1480;
double *t13 = t8 + i;
...
for (i=0; i<P_ncols; i+=__s1481) {
// 6_1
int __m1481 = i + __s1481 > P_ncols ? P_ncols - i : __s1481;
double *t22 = P + i;
double *t20 = t10 + i;
double *t21 = Q + i;
for (j=0; j<P_ncols; j+=1) {
