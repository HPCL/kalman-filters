...
double *t8 = A;
double *t12 = A;
for (i=0; i<P_ncols; i+=__s198) {
// 2_1
int __m198 = i + __s198 > P_ncols ? P_ncols - i : __s198;
double *t17 = t18 + i*P_ncols;
double *t16 = t8 + i*P_ncols;
for (j=0; j<__m198; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s199) {
// 4_1
int __m199 = i + __s199 > P_ncols ? P_ncols - i : __s199;
double *t20 = t21 + i;
...
for (i=0; i<P_ncols; i+=__s200) {
// 6_1
int __m200 = i + __s200 > P_ncols ? P_ncols - i : __s200;
double *t24 = P + i;
double *t22 = t13 + i;
double *t23 = Q + i;
for (j=0; j<P_ncols; j+=1) {
