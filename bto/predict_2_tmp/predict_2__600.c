...
for (i=0; i<P_ncols; i+=__s1482) {
// 4_1
int __m1482 = i + __s1482 > P_ncols ? P_ncols - i : __s1482;
double *t18 = t19 + i;
...
for (i=0; i<P_ncols; i+=__s1483) {
// 6_1
int __m1483 = i + __s1483 > P_ncols ? P_ncols - i : __s1483;
double *t22 = P + i;
double *t20 = t11 + i;
double *t21 = Q + i;
for (j=0; j<P_ncols; j+=1) {
