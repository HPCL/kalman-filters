...
double *t10 = t19;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s1487) {
// 2_1
int __m1487 = i + __s1487 > P_ncols ? P_ncols - i : __s1487;
double *t13 = t8 + i;
...
for (i=0; i<P_ncols; i+=__s1488) {
// 6_1
int __m1488 = i + __s1488 > P_ncols ? P_ncols - i : __s1488;
double *t22 = P + i;
double *t20 = t10 + i;
double *t21 = Q + i;
for (j=0; j<P_ncols; j+=1) {
