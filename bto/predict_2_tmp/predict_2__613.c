...
for (i=0; i<P_ncols; i+=__s1494) {
// 4_1
int __m1494 = i + __s1494 > P_ncols ? P_ncols - i : __s1494;
double *t18 = t19 + i;
...
for (i=0; i<P_ncols; i+=__s1495) {
// 6_1
int __m1495 = i + __s1495 > P_ncols ? P_ncols - i : __s1495;
double *t22 = P + i;
double *t20 = t11 + i;
double *t21 = Q + i;
for (j=0; j<P_ncols; j+=1) {
