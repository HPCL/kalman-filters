...
double *t9 = t15;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s205) {
// 2_1
int __m205 = i + __s205 > P_ncols ? P_ncols - i : __s205;
double *t14 = t15 + i*P_ncols;
double *t13 = t8 + i*P_ncols;
for (j=0; j<__m205; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s206) {
// 6_1
int __m206 = i + __s206 > P_ncols ? P_ncols - i : __s206;
double *t21 = P + i;
double *t19 = t10 + i;
double *t20 = Q + i;
for (j=0; j<P_ncols; j+=1) {
