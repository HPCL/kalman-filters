...
for (i=0; i<P_ncols; i+=__s1510) {
// 4_1
int __m1510 = i + __s1510 > P_ncols ? P_ncols - i : __s1510;
double *t18 = t19 + i;
...
for (i=0; i<P_ncols; i+=__s1511) {
// 6_1
int __m1511 = i + __s1511 > P_ncols ? P_ncols - i : __s1511;
double *t22 = P + i;
double *t20 = t11 + i;
double *t21 = Q + i;
for (j=0; j<P_ncols; j+=1) {
