...
double *t8 = A;
double *t12 = A;
for (i=0; i<P_ncols; i+=__s1522) {
// 2_1
int __m1522 = i + __s1522 > P_ncols ? P_ncols - i : __s1522;
double *t14 = t15 + i*P_ncols;
double *t13 = t8 + i*P_ncols;
for (j=0; j<__m1522; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s1523) {
// 4_1
int __m1523 = i + __s1523 > P_ncols ? P_ncols - i : __s1523;
double *t16 = t10 + i;
double *t24 = t12 + i;
