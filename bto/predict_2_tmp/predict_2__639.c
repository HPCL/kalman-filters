...
for (i=0; i<P_ncols; i+=__s1524) {
// 4_1
int __m1524 = i + __s1524 > P_ncols ? P_ncols - i : __s1524;
double *t17 = t8 + i;
double *t25 = t10 + i;
for (j=0; j<P_ncols; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s1525) {
// 6_1
int __m1525 = i + __s1525 > P_ncols ? P_ncols - i : __s1525;
double *t23 = P + i;
double *t21 = t11 + i;
double *t22 = Q + i;
for (j=0; j<P_ncols; j+=1) {
