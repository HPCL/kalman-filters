...
double *t8 = A;
double *t12 = A;
for (i=0; i<P_ncols; i+=__s1552) {
// 2_1
int __m1552 = i + __s1552 > P_ncols ? P_ncols - i : __s1552;
double *t14 = t15 + i*P_ncols;
double *t13 = t8 + i*P_ncols;
for (j=0; j<__m1552; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s1553) {
// 4_1
int __m1553 = i + __s1553 > P_ncols ? P_ncols - i : __s1553;
double *t16 = t10 + i;
double *t24 = t12 + i;
