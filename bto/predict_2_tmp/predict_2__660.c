...
for (i=0; i<P_ncols; i+=__s1554) {
// 4_1
int __m1554 = i + __s1554 > P_ncols ? P_ncols - i : __s1554;
double *t17 = t18 + i*P_ncols;
double *t16 = t8 + i*P_ncols;
for (j=0; j<__m1554; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s1555) {
// 6_1
int __m1555 = i + __s1555 > P_ncols ? P_ncols - i : __s1555;
double *t21 = P + i*P_ncols;
double *t19 = t10 + i*P_ncols;
double *t20 = Q + i*P_ncols;
for (j=0; j<__m1555; j+=1) {
// 6_2
