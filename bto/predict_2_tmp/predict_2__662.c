...
double *t9 = t15;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s1560) {
// 2_1
int __m1560 = i + __s1560 > P_ncols ? P_ncols - i : __s1560;
double *t14 = t15 + i*P_ncols;
double *t13 = t8 + i*P_ncols;
for (j=0; j<__m1560; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s1561) {
// 6_1
int __m1561 = i + __s1561 > P_ncols ? P_ncols - i : __s1561;
double *t21 = P + i*P_ncols;
double *t19 = t10 + i*P_ncols;
double *t20 = Q + i*P_ncols;
for (j=0; j<__m1561; j+=1) {
// 6_2
