...
double *t8 = A;
double *t12 = A;
for (i=0; i<P_ncols; i+=__s1594) {
// 2_1
int __m1594 = i + __s1594 > P_ncols ? P_ncols - i : __s1594;
double *t17 = t18 + i*P_ncols;
double *t16 = t8 + i*P_ncols;
for (j=0; j<__m1594; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s1595) {
// 4_1
int __m1595 = i + __s1595 > P_ncols ? P_ncols - i : __s1595;
double *t19 = t10 + i;
double *t27 = t12 + i;
...
for (i=0; i<P_ncols; i+=__s1596) {
// 6_1
int __m1596 = i + __s1596 > P_ncols ? P_ncols - i : __s1596;
double *t25 = P + i*P_ncols;
double *t23 = t13 + i*P_ncols;
double *t24 = Q + i*P_ncols;
for (j=0; j<__m1596; j+=1) {
// 6_2
