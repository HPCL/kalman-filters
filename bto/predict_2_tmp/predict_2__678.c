...
double *t8 = A;
double *t12 = A;
for (i=0; i<P_ncols; i+=__s1597) {
// 2_1
int __m1597 = i + __s1597 > P_ncols ? P_ncols - i : __s1597;
double *t14 = t15 + i*P_ncols;
double *t13 = t8 + i*P_ncols;
for (j=0; j<__m1597; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s1598) {
// 4_1
int __m1598 = i + __s1598 > P_ncols ? P_ncols - i : __s1598;
double *t17 = t18 + i;
