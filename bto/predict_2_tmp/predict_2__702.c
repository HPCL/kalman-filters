...
double *t9 = t17;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s1640) {
// 2_1
int __m1640 = i + __s1640 > P_ncols ? P_ncols - i : __s1640;
double *t16 = t17 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m1640; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s1641) {
// 4_1
int __m1641 = i + __s1641 > P_ncols ? P_ncols - i : __s1641;
double *t19 = t20 + i*P_ncols;
double *t18 = t10 + i*P_ncols;
for (j=0; j<__m1641; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s1642) {
// 6_1
int __m1642 = i + __s1642 > P_ncols ? P_ncols - i : __s1642;
double *t23 = P + i*P_ncols;
double *t21 = t12 + i*P_ncols;
double *t22 = Q + i*P_ncols;
for (j=0; j<__m1642; j+=1) {
// 6_2
