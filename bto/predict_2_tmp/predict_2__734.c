...
double *t9 = t14;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s1689) {
// 2_1
int __m1689 = i + __s1689 > P_ncols ? P_ncols - i : __s1689;
double *t13 = t14 + i*P_ncols;
double *t12 = t8 + i*P_ncols;
for (j=0; j<__m1689; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s1690) {
// 4_1
int __m1690 = i + __s1690 > P_ncols ? P_ncols - i : __s1690;
double *t16 = t17 + i*P_ncols;
double *t15 = t10 + i*P_ncols;
for (j=0; j<__m1690; j+=1) {
// 4_2
