...
double *t8 = A;
double *t12 = A;
for (i=0; i<P_ncols; i+=__s1694) {
// 2_1
int __m1694 = i + __s1694 > P_ncols ? P_ncols - i : __s1694;
double *t17 = t18 + i*P_ncols;
double *t16 = t8 + i*P_ncols;
for (j=0; j<__m1694; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s1695) {
// 4_1
int __m1695 = i + __s1695 > P_ncols ? P_ncols - i : __s1695;
double *t19 = t10 + i;
double *t27 = t12 + i;
...
for (i=0; i<P_ncols; i+=__s1696) {
// 6_1
int __m1696 = i + __s1696 > P_ncols ? P_ncols - i : __s1696;
double *t25 = P + i;
double *t23 = t13 + i;
double *t24 = Q + i;
for (j=0; j<P_ncols; j+=1) {
