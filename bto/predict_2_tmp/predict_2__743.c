...
for (i=0; i<P_ncols; i+=__s1709) {
// 4_1
int __m1709 = i + __s1709 > P_ncols ? P_ncols - i : __s1709;
double *t17 = t18 + i*P_ncols;
double *t16 = t8 + i*P_ncols;
for (j=0; j<__m1709; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s1710) {
// 6_1
int __m1710 = i + __s1710 > P_ncols ? P_ncols - i : __s1710;
double *t21 = P + i*P_ncols;
double *t19 = t10 + i*P_ncols;
double *t20 = Q + i*P_ncols;
for (j=0; j<__m1710; j+=1) {
// 6_2
