...
double *t8 = A;
double *t12 = A;
for (i=0; i<P_ncols; i+=__s1727) {
// 2_1
int __m1727 = i + __s1727 > P_ncols ? P_ncols - i : __s1727;
double *t13 = t8 + i;
...
for (i=0; i<P_ncols; i+=__s1728) {
// 4_1
int __m1728 = i + __s1728 > P_ncols ? P_ncols - i : __s1728;
double *t17 = t10 + i;
double *t25 = t12 + i;
for (j=0; j<P_ncols; j+=1) {
// 4_2
