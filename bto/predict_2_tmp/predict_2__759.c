...
double *t9 = t17;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s1734) {
// 2_1
int __m1734 = i + __s1734 > P_ncols ? P_ncols - i : __s1734;
double *t16 = t17 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m1734; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s1735) {
// 4_1
int __m1735 = i + __s1735 > P_ncols ? P_ncols - i : __s1735;
double *t19 = t20 + i*P_ncols;
double *t18 = t10 + i*P_ncols;
for (j=0; j<__m1735; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s1736) {
// 6_1
int __m1736 = i + __s1736 > P_ncols ? P_ncols - i : __s1736;
double *t23 = P + i*P_ncols;
double *t21 = t12 + i*P_ncols;
double *t22 = Q + i*P_ncols;
for (j=0; j<__m1736; j+=1) {
// 6_2
