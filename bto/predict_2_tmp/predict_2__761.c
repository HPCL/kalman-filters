...
double *t8 = A;
double *t12 = A;
for (i=0; i<P_ncols; i+=__s1737) {
// 2_1
int __m1737 = i + __s1737 > P_ncols ? P_ncols - i : __s1737;
double *t16 = t8 + i;
...
for (i=0; i<P_ncols; i+=__s1738) {
// 4_1
int __m1738 = i + __s1738 > P_ncols ? P_ncols - i : __s1738;
double *t21 = t22 + i;
...
for (i=0; i<P_ncols; i+=__s1739) {
// 6_1
int __m1739 = i + __s1739 > P_ncols ? P_ncols - i : __s1739;
double *t25 = P + i*P_ncols;
double *t23 = t13 + i*P_ncols;
double *t24 = Q + i*P_ncols;
for (j=0; j<__m1739; j+=1) {
// 6_2
