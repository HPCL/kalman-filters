...
double *t9 = t14;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s1798) {
// 2_1
int __m1798 = i + __s1798 > P_ncols ? P_ncols - i : __s1798;
double *t13 = t14 + i*P_ncols;
double *t12 = t8 + i*P_ncols;
for (j=0; j<__m1798; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s1799) {
// 4_1
int __m1799 = i + __s1799 > P_ncols ? P_ncols - i : __s1799;
double *t16 = t17 + i*P_ncols;
double *t15 = t10 + i*P_ncols;
for (j=0; j<__m1799; j+=1) {
// 4_2
