...
for (i=0; i<P_ncols; i+=__s1816) {
// 4_1
int __m1816 = i + __s1816 > P_ncols ? P_ncols - i : __s1816;
double *t17 = t18 + i*P_ncols;
double *t16 = t8 + i*P_ncols;
for (j=0; j<__m1816; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s1817) {
// 6_1
int __m1817 = i + __s1817 > P_ncols ? P_ncols - i : __s1817;
double *t21 = P + i*P_ncols;
double *t19 = t10 + i*P_ncols;
double *t20 = Q + i*P_ncols;
for (j=0; j<__m1817; j+=1) {
// 6_2
