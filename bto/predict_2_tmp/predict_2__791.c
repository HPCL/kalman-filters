...
double *t9 = t17;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s1856) {
// 2_1
int __m1856 = i + __s1856 > P_ncols ? P_ncols - i : __s1856;
double *t16 = t17 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m1856; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s1857) {
// 4_1
int __m1857 = i + __s1857 > P_ncols ? P_ncols - i : __s1857;
double *t19 = t20 + i*P_ncols;
double *t18 = t10 + i*P_ncols;
for (j=0; j<__m1857; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s1858) {
// 6_1
int __m1858 = i + __s1858 > P_ncols ? P_ncols - i : __s1858;
double *t23 = P + i*P_ncols;
double *t21 = t12 + i*P_ncols;
double *t22 = Q + i*P_ncols;
for (j=0; j<__m1858; j+=1) {
// 6_2
