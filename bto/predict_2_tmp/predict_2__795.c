...
double *t9 = t17;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s1871) {
// 2_1
int __m1871 = i + __s1871 > P_ncols ? P_ncols - i : __s1871;
double *t16 = t17 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m1871; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s1872) {
// 4_1
int __m1872 = i + __s1872 > P_ncols ? P_ncols - i : __s1872;
double *t19 = t20 + i*P_ncols;
double *t18 = t10 + i*P_ncols;
for (j=0; j<__m1872; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s1873) {
// 6_1
int __m1873 = i + __s1873 > P_ncols ? P_ncols - i : __s1873;
double *t23 = P + i*P_ncols;
double *t21 = t12 + i*P_ncols;
double *t22 = Q + i*P_ncols;
for (j=0; j<__m1873; j+=1) {
// 6_2
