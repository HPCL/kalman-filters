...
double *t19 = malloc(sizeof(double)*__s36*P_ncols);
double *t16 = malloc(sizeof(double)*__s36*P_ncols);
double *t8 = A;
for (i=0; i<P_ncols; i+=__s36) {
// 2_1
int __m36 = i + __s36 > P_ncols ? P_ncols - i : __s36;
