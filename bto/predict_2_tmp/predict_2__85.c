...
double *t9 = t15;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s266) {
// 2_1
int __m266 = i + __s266 > P_ncols ? P_ncols - i : __s266;
...
for (i=0; i<P_ncols; i+=__s267) {
// 6_1
int __m267 = i + __s267 > P_ncols ? P_ncols - i : __s267;
double *t21 = P + i;
double *t19 = t10 + i;
double *t20 = Q + i;
for (j=0; j<P_ncols; j+=1) {
