...
double *t9 = t17;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s2127) {
// 2_1
int __m2127 = i + __s2127 > P_ncols ? P_ncols - i : __s2127;
double *t16 = t17 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m2127; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s2128) {
// 4_1
int __m2128 = i + __s2128 > P_ncols ? P_ncols - i : __s2128;
double *t19 = t20 + i*P_ncols;
double *t18 = t10 + i*P_ncols;
for (j=0; j<__m2128; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s2129) {
// 6_1
int __m2129 = i + __s2129 > P_ncols ? P_ncols - i : __s2129;
double *t23 = P + i*P_ncols;
double *t21 = t12 + i*P_ncols;
double *t22 = Q + i*P_ncols;
for (j=0; j<__m2129; j+=1) {
// 6_2
