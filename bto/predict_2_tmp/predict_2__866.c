...
double *t16 = malloc(sizeof(double)*__s2165*P_ncols);
double *t20 = malloc(sizeof(double)*P_ncols*P_ncols);
double *t12 = t20;
double *t11 = t20;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s2165) {
// 2_1
int __m2165 = i + __s2165 > P_ncols ? P_ncols - i : __s2165;
double *t19 = t20 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m2165; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s2167) {
// 6_1
int __m2167 = i + __s2167 > P_ncols ? P_ncols - i : __s2167;
double *t23 = P + i*P_ncols;
double *t21 = t12 + i*P_ncols;
double *t22 = Q + i*P_ncols;
for (j=0; j<__m2167; j+=1) {
// 6_2
