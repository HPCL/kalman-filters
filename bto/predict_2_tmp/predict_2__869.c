...
double *t9 = t14;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s2174) {
// 2_1
int __m2174 = i + __s2174 > P_ncols ? P_ncols - i : __s2174;
double *t13 = t14 + i*P_ncols;
double *t12 = t8 + i*P_ncols;
for (j=0; j<__m2174; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s2175) {
// 4_1
int __m2175 = i + __s2175 > P_ncols ? P_ncols - i : __s2175;
double *t16 = t17 + i*P_ncols;
double *t15 = t10 + i*P_ncols;
for (j=0; j<__m2175; j+=1) {
// 4_2
