...
double *t9 = t17;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s2276) {
// 2_1
int __m2276 = i + __s2276 > P_ncols ? P_ncols - i : __s2276;
double *t16 = t17 + i*P_ncols;
double *t15 = t8 + i*P_ncols;
for (j=0; j<__m2276; j+=1) {
// 2_2
...
for (i=0; i<P_ncols; i+=__s2277) {
// 4_1
int __m2277 = i + __s2277 > P_ncols ? P_ncols - i : __s2277;
double *t19 = t20 + i*P_ncols;
double *t18 = t10 + i*P_ncols;
for (j=0; j<__m2277; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s2278) {
// 6_1
int __m2278 = i + __s2278 > P_ncols ? P_ncols - i : __s2278;
double *t23 = P + i*P_ncols;
double *t21 = t12 + i*P_ncols;
double *t22 = Q + i*P_ncols;
for (j=0; j<__m2278; j+=1) {
// 6_2
