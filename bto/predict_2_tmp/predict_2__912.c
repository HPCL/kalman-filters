...
double *t10 = t15;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s2322) {
// 2_1
int __m2322 = i + __s2322 > P_ncols ? P_ncols - i : __s2322;
double *t12 = t8 + i;
...
for (i=0; i<P_ncols; i+=__s2323) {
// 4_1
int __m2323 = i + __s2323 > P_ncols ? P_ncols - i : __s2323;
double *t17 = t18 + i*P_ncols;
double *t16 = t10 + i*P_ncols;
for (j=0; j<__m2323; j+=1) {
// 4_2
