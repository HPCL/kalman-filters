...
double *t10 = t15;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s2398) {
// 2_1
int __m2398 = i + __s2398 > P_ncols ? P_ncols - i : __s2398;
double *t12 = t8 + i;
...
for (i=0; i<P_ncols; i+=__s2399) {
// 4_1
int __m2399 = i + __s2399 > P_ncols ? P_ncols - i : __s2399;
double *t17 = t18 + i*P_ncols;
double *t16 = t10 + i*P_ncols;
for (j=0; j<__m2399; j+=1) {
// 4_2
