...
double *t10 = t18;
double *t8 = A;
for (i=0; i<P_ncols; i+=__s2449) {
// 2_1
int __m2449 = i + __s2449 > P_ncols ? P_ncols - i : __s2449;
double *t15 = t8 + i;
...
for (i=0; i<P_ncols; i+=__s2450) {
// 4_1
int __m2450 = i + __s2450 > P_ncols ? P_ncols - i : __s2450;
double *t20 = t21 + i*P_ncols;
double *t19 = t10 + i*P_ncols;
for (j=0; j<__m2450; j+=1) {
// 4_2
...
for (i=0; i<P_ncols; i+=__s2451) {
// 6_1
int __m2451 = i + __s2451 > P_ncols ? P_ncols - i : __s2451;
double *t24 = P + i*P_ncols;
double *t22 = t12 + i*P_ncols;
double *t23 = Q + i*P_ncols;
for (j=0; j<__m2451; j+=1) {
// 6_2
